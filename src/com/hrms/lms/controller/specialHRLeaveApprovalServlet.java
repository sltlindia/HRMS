...
/**
 * Servlet implementation class specialHRLeaveApprovalServlet
 */
public class specialHRLeaveApprovalServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public specialHRLeaveApprovalServlet() {
        super();
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(user!=null)
		{
			...
			String sunday = null , holiday = null , name = null;
					int EMPCODE = 0;
			int show_view = 0;
			int leave_id = 0;
			int unplancounter = 0;
						...
						//	String name = employeeBean2.getFirstname()+" "+employeeBean2.getLastname();
							...
							new Thread(new Runnable() {
								    ...
								    public void run() {
								    	...
								    	String to = EmailId;
								    	String sub = name1 + " apply for leave";
								    	String leavefrom = lffff;
								    	String leaveto = tllll;
								    	double days = dd;
								    	String mobileNo = no;
								    	int emp_code = tempempcode;
								    	int mail_view = 1;
								    
								    	System.out.println("test");
								    	
								    	Mailer.send(to, sub, leavefrom, leaveto, days, emp_code,mobileNo,alert1,lId,name1);
							 ...
							 request.getRequestDispatcher("pendingLeave").forward(request, response);
