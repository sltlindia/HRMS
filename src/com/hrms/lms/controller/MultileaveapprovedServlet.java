...
/**
 * Servlet implementation class MultileaveapprovedServlet
 */
public class MultileaveapprovedServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MultileaveapprovedServlet() {
        super();
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("leave_id") != null)
		{
			...
			System.out.println("LeaveID" + leave_id);
		}
		...
		List<LeaveBean> listOfLeave1 = allListDAO.getLeaveByLeaveId(leave_id);
		...
		for(LeaveBean leaveBean : listOfLeave1)
		{
			...
			LeaveType = leaveBean.getLeaveType_ID();
			...
			days = leaveBean.getDay_count();
			Leave_id = leave_id;
			Emp_MasterID =  leaveBean.getEmployeeBean().getEmployee_master_id();
			month_id = leaveBean.getMonth_ID();
			//reason = request.getParameter("remarks");
			empid = leaveBean.getEmployeeBean().getEmployee_master_id();
