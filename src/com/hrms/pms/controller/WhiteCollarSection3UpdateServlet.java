...
/**
 * Servlet implementation class WhiteCollarSection3UpdateServlet
 */
public class WhiteCollarSection3UpdateServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(a_cmt.equals("-") && request.getParameter("employee_done") == null){
