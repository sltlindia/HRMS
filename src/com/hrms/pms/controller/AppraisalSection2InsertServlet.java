...
public class AppraisalSection2InsertServlet extends HttpServlet {
			...
			for (int i = 0; i < items.size(); i++) {
				...
				if (item.isFormField()) {
					...
					if (fieldName.equalsIgnoreCase("remarks")) {
						...
						AppraisalCriteriaGradeBean appraisalCriteriaGradeBean = new AppraisalCriteriaGradeBean(remarks, appraisalBean, appraisalGradeBean, appraisalCriteriaBean);
						boolean result = allInsertDAO.appraisalGradeInsert(appraisalCriteriaGradeBean);
					}
