...
public class MilestoneAllocationInsertServlet extends HttpServlet {
				...
				for (String chkmonth : startmonth) {
					...
					monthBean.setMonth_id(Month);
						...
						for (Object[] aRow : listOfTask) {
							...
							boolean result = allInsertDAO.projectAllocationInsert(yearBean, projectMasterBean,
									monthBean, employeeBean, manager_id, taskMasterBean,myId);
							System.out.println("milestone inserted:" + t.getTask_master_id());
