...
public class AllInsertCoreHrDAO {
	...
	public boolean addInterviewTrackerDesignation(InterviewTrackerDesignationBean interviewTrackerDesignationBean){
		 Session session = HibernateUtil.openSession();
		 Transaction tx = null;	
		 try {
			 tx = session.getTransaction();
			 tx.begin();
			 session.saveOrUpdate(interviewTrackerDesignationBean);
			 tx.commit();
		 } catch (Exception e) {
			 if (tx != null) {
				 tx.rollback();
	...
	public boolean addCompany(CompanyListBean companyListBean){
		 Session session = HibernateUtil.openSession();
		 Transaction tx = null;	
		 try {
			 tx = session.getTransaction();
			 tx.begin();
			 session.saveOrUpdate(companyListBean);
			 tx.commit();
		 } catch (Exception e) {
			 if (tx != null) {
				 tx.rollback();
	...
	public boolean addManager(ManagerBean managerBean){
		 ...
		 try {
			 tx = session.getTransaction();
			 tx.begin();
			 session.saveOrUpdate(managerBean);
			 tx.commit();
		 } catch (Exception e) {
			 if (tx != null) {
				 tx.rollback();
	...
	public boolean addSubDepartment(SubDepartmentBean subDepartmentBean){
		 Session session = HibernateUtil.openSession();
		 Transaction tx = null;	
		 try {
			 tx = session.getTransaction();
			 tx.begin();
			 session.saveOrUpdate(subDepartmentBean);
			 tx.commit();
		 } catch (Exception e) {
			 if (tx != null) {
				 tx.rollback();
