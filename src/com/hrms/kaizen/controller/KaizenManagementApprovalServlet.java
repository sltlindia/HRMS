...
public class KaizenManagementApprovalServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		EmployeeBean managerInfoBean = loginDAO.getEmailId(kaizenBean.getManager_id());
		...
		if(!aStatus.equalsIgnoreCase("pending")) {
			boolean result1 = allKaizenUpdateDAO.kaizenMainApprovalRejetcion(kaizen_id, aStatus);
