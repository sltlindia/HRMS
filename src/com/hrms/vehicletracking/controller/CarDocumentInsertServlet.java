...
/**
 * Servlet implementation class CarDocumentInsertServlet
 */
public class CarDocumentInsertServlet extends HttpServlet {
				...
				if (item.isFormField()) {
					...
					try {
						...
						if (fileName.isEmpty()) {
							...
							VehiclePolicyDocumentBean vehiclePolicyDocumentBean = new VehiclePolicyDocumentBean(registered_no, description, fromDate, toDate, attachment,amount,policyNo, vehicleBean);
