...
public class InterviewFeedbackInsertServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		if (user != null) {
			...
			String problem_solving_skills = null;
			String computer_skills = null;
			String job_stability = null;
			String total = null;
			String comment_problem_solving_skills = null;
			String comment_computer_skills = null;
			...
			problem_solving_skills = request.getParameter("problemSolvingSkillsDecisionMakingSkills");
			System.out.println("problem_solving_skills:" + problem_solving_skills);
			computer_skills = request.getParameter("computerSkills");
			System.out.println("computer_skills:" + computer_skills);
			job_stability = request.getParameter("jobStabilityJobCommitment");
			System.out.println("job_stability:" + job_stability);
			total = request.getParameter("total");
			System.out.println("total:" + total);
			
			comment_problem_solving_skills = request.getParameter("commentProblemSolvingSkillsDecisionMakingSkills");
			System.out.println("comment_problem_solving_skills:" + comment_problem_solving_skills);
			comment_computer_skills = request.getParameter("commentComputerSkills");
			System.out.println("comment_computer_skills:" + comment_computer_skills);
			...
			if (decision.equalsIgnoreCase("rejected")) {
				...
				interviewFeedbackBean = new InterviewFeedbackBean(interview_date, start_time, end_time, comments, 
						...
						submission_date, problem_solving_skills, computer_skills, job_stability, total, 
						comment_problem_solving_skills, comment_computer_skills, comment_job_stability, 
						comment_total, jobLocationBean, vacancyFormBean, resumeDataBean, employeeBean);
						
						
				boolean result = allInsertDAO.interviewfeedbackInsert(interviewFeedbackBean);
				if (result == true) {
					AllUpdateDAO allUpdateDAO = new AllUpdateDAO();
					boolean result2 = allUpdateDAO.resumeStatusUpdate(status, resume_id, employee_master_id);
				...
				interviewFeedbackBean = new InterviewFeedbackBean(interview_date, start_time, end_time, comments,
						...
						problem_solving_skills, computer_skills, job_stability, total, comment_problem_solving_skills, 
						comment_computer_skills, comment_job_stability, comment_total, roleBean, jobLocationBean, 
						departmentBean, resumeDataBean, employeeBean, vacancyFormBean);
				boolean result = allInsertDAO.interviewfeedbackInsert(interviewFeedbackBean);
				if (result == true) {
					AllUpdateDAO allUpdateDAO = new AllUpdateDAO();
					boolean result2 = allUpdateDAO.resumeStatusUpdate(status, resume_id, employee_master_id);
				...
				interviewFeedbackBean = new InterviewFeedbackBean(interview_date, start_time, end_time, comments, 
						...
						comment_interest_in_position, comment_presentation, submission_date, problem_solving_skills, 
						computer_skills, job_stability, total, comment_problem_solving_skills, comment_computer_skills, 
						comment_job_stability, comment_total, vacancyFormBean, resumeDataBean, employeeBean);
				boolean result = allInsertDAO.interviewfeedbackInsert(interviewFeedbackBean);
				if (result == true) {
					AllUpdateDAO allUpdateDAO = new AllUpdateDAO();
					boolean result2 = allUpdateDAO.resumeStatusUpdate(status, resume_id, employee_master_id);
			...
			else if (decision.equalsIgnoreCase("on hold"))
			{
				...
				interviewFeedbackBean = new InterviewFeedbackBean(interview_date, start_time, end_time, comments, 
						...
						presentation, problem_solving_skills, computer_skills, job_stability, total, decision, 
						jobLocationBean, employeeBean, vacancyFormBean, comment_relevance_of_education, 
						comment_communication_skills, comment_interest_in_position, comment_presentation, 
						comment_problem_solving_skills, comment_computer_skills, comment_job_stability, 
						comment_total, submission_date, remark,  resumeDataBean);
				boolean result = allInsertDAO.interviewfeedbackInsert(interviewFeedbackBean);
				if (result == true) {
					AllUpdateDAO allUpdateDAO = new AllUpdateDAO();
					boolean result2 = allUpdateDAO.resumeStatusUpdate(status, resume_id, employee_master_id);
