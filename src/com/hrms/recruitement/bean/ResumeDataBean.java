...
public class ResumeDataBean implements Serializable {
	...
	private DailyCallingStatusBean dailyCallingStatusBean;
	...
	public ResumeDataBean(String name, String gender, String date_of_birth, String residing_country,
			...
			int expected_salary, String current_salary, String notice_period, String submission_date, String speciality,
			SourceOfResumeBean sourceOfResumeBean, EmployeeBean employeeBean, String graduate_qualification,
			String post_graduate_qualification, String phd_qualification, DailyCallingStatusBean dailyCallingStatusBean) {
		// super();
		this.name = name;
		this.gender = gender;
		...
		this.dailyCallingStatusBean = dailyCallingStatusBean;
	}
	
	
	public ResumeDataBean(VacancyFormBean vacancyFormBean , String candiname, String gender , String current_location, String current_contact_no, String email , 
			String educational_qualification, String status, String upload_resume , String submission_date , SourceOfResumeBean sourceOfResumeBean ,EmployeeBean employeeBean, DailyCallingStatusBean dailyCallingStatusBean)
	{
		this.vacancyFormBean = vacancyFormBean;
		this.name = candiname;
		this.gender = gender;
	...
	@ManyToOne
	@JoinColumn(name = "daily_calling_status_id")
	public DailyCallingStatusBean getDailyCallingStatusBean() {
		return dailyCallingStatusBean;
	}

	public void setDailyCallingStatusBean(DailyCallingStatusBean dailyCallingStatusBean) {
		this.dailyCallingStatusBean = dailyCallingStatusBean;
	}
