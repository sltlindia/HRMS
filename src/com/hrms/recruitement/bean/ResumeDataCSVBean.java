...
public class ResumeDataCSVBean implements Serializable{
...
private static final long serialVersionUID = 1L;
	...
	public ResumeDataCSVBean(){}
	
	
	

	public ResumeDataCSVBean(String name, String gender, String date_of_birth, String residing_country,
			...
			String role_as, String current_functional_area, String current_role, String key_skills,
			String upload_resume, String status, String ex_employee, String employee_code, String expected_salary,
			String current_salary, String notice_period, String submission_date, String reply_date, String speciality,
			String graduate_qualification, String post_graduate_qualification, String phd_qualification,
			VacancyFormBean vacancyFormBean, SourceOfResumeBean sourceOfResumeBean, EmployeeBean employeeBean) {
		super();
		this.name = name;
		this.gender = gender;
