...
@Entity
@Table(name="tds_hr_totald_tbl")
public class TDSHrTotalDBean implements Serializable{

	private int tds_hr_totald_id;
	...
	public TDSHrTotalDBean() {}

	public TDSHrTotalDBean(double life_insurance, double ePF, double pPF, double nSC, double mF, double tuition_fees,
			...
			double payable_a_total_d, double payable_d_total_d, double payable_total_d, TDSHrBean tdsHrBean) {
		super();
	...
	public TDSHrTotalDBean(int tds_hr_totald_id, double life_insurance, double ePF, double pPF, double nSC, double mF,
			...
			double payable_a_total_d, double payable_d_total_d, double payable_total_d, TDSHrBean tdsHrBean) {
		super();
		this.tds_hr_totald_id = tds_hr_totald_id;
		this.life_insurance = life_insurance;
		EPF = ePF;
		PPF = pPF;
		NSC = nSC;
	...
	@Id
	@Column(name="tds_hr_totald_id")
	@GeneratedValue
	public int getTds_hr_totald_id() {
		return tds_hr_totald_id;
	}

	public void setTds_hr_totald_id(int tds_hr_totald_id) {
		this.tds_hr_totald_id = tds_hr_totald_id;
	}
