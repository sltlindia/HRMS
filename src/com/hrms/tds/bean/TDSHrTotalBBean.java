...
@Entity
@Table(name="tds_hr_totalb_tbl")
public class TDSHrTotalBBean implements Serializable{

	private int tds_hr_totalb_id;
	...
	public TDSHrTotalBBean() {}

	
	public TDSHrTotalBBean(double conveyance, double d_conveyance, String metro_non_metro, double a_total_basic,
	...
	public TDSHrTotalBBean(int tds_hr_totalb_id, double conveyance, double d_conveyance, String metro_non_metro,
			...
			double total_b, TDSHrBean tdsHrBean) {
		super();
		this.tds_hr_totalb_id = tds_hr_totalb_id;
		this.conveyance = conveyance;
		this.d_conveyance = d_conveyance;
		this.metro_non_metro = metro_non_metro;
		this.a_total_basic = a_total_basic;
	...
	@Id
	@Column(name="tds_hr_totalb_id")
	@GeneratedValue
	public int getTds_hr_totalb_id() {
		return tds_hr_totalb_id;
	}

	public void setTds_hr_totalb_id(int tds_hr_totalb_id) {
		this.tds_hr_totalb_id = tds_hr_totalb_id;
	}
