...
@Entity
@Table(name="tds_totala_tbl")
public class TDSTotalABean implements Serializable{
	
	private int tds_totala_id;
	...
	public TDSTotalABean() {
		// TODO Auto-generated constructor stub
	}
	
	
	public TDSTotalABean(double annual_gross_salary, double bonus, double leaveCount, double incentive,
			double previous_employeed_salary, double performance_pay, double full_final_leave, double full_final_bonus,
			double total_a, TDSBean tdsBean) {
		super();
	...
	public TDSTotalABean(int tds_totala_id, double annual_gross_salary, double bonus, double leaveCount,
			double incentive, double previous_employeed_salary, double performance_pay, double full_final_leave,
			double full_final_bonus, double total_a, TDSBean tdsBean) {
		super();
		this.tds_totala_id = tds_totala_id;
		this.annual_gross_salary = annual_gross_salary;
		this.bonus = bonus;
		this.leaveCount = leaveCount;
		this.incentive = incentive;
	...
	@Id
	@Column(name="tds_totala_id")
	@GeneratedValue
	public int getTds_totala_id() {
		return tds_totala_id;
	}

	public void setTds_totala_id(int tds_totala_id) {
		this.tds_totala_id = tds_totala_id;
	}
