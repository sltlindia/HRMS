...
@Entity
@Table(name="tds_hr_totalf_tbl")
public class TDSHrTotalFBean implements Serializable{

	private int tds_hr_totalf_id;
	...
	public TDSHrTotalFBean(double a_self, double d_self, String father_birthdate, double a_parents, double d_parents,
			...
			double payable_total_tax, double payable_edu_cess, double payable_total_h, TDSHrBean tdsHrBean,
			double april, double may, double june, double july, double august, double september, double october,
			double november, double december, double january, double february, double march, double tax_paid,
			double tax_payable) {
		super();
		this.a_self = a_self;
		this.d_self = d_self;
	...
	public TDSHrTotalFBean(int tds_hr_totalf_id, double a_self, double d_self, String father_birthdate,
			...
			double tax_payable) {
		super();
		this.tds_hr_totalf_id = tds_hr_totalf_id;
		this.a_self = a_self;
		this.d_self = d_self;
		this.father_birthdate = father_birthdate;
		this.a_parents = a_parents;
	...
	@Id
	@Column(name="tds_hr_totalf_id")
	@GeneratedValue
	public int getTds_hr_totalf_id() {
		return tds_hr_totalf_id;
	}

	public void setTds_hr_totalf_id(int tds_hr_totalf_id) {
		this.tds_hr_totalf_id = tds_hr_totalf_id;
	}
