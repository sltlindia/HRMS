...
public class TDSHistoryBean implements Serializable{
		...
		public TDSHistoryBean(String status, String submission_date, String period, double annual_gross_salary,
				...
				String landlord_name, String landlord_pan_no, double a_medical, double provided_medical_bills, double d_medical, String monthly_yearly,
				double yearly_mealcard, String monthly_start_date, String monthly_end_date, int days,
				...
				double tax_saver_deposite, String other_document, double other, double a_total_d, double d_total_d, double a_NPS, double d_NPS,
				double a_RGESS, double d_RGESS, double total_NPS_RGESS, double total_e, double a_self, double d_self,
				String father_birthdate, double a_parents, double d_parents, double a_health_checkup,
				double d_health_checkup, double a_mediclaim, double d_mediclaim, String cash_cheque,
				...
				double total_h, TDSBean tdsBean, EmployeeBean employeeBean) {
			super();
			this.status = status;
