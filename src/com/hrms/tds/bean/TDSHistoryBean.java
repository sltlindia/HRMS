...
@Entity
@Table(name="tds_history_tbl")
public class TDSHistoryBean implements Serializable{

		private int tds_history_id;
		...
		public TDSHistoryBean() {
			// TODO Auto-generated constructor stub
		}
		
		public TDSHistoryBean(String status, String submission_date, String period, double annual_gross_salary,
				double bonus, double leaveCount, double incentive, double previous_employeed_salary,
				double performance_pay, double full_final_leave, double full_final_bonus, double total_a,
				double conveyance, double d_conveyance, String metro_non_metro, double a_total_basic,
				...
				double d_medical, double meal_card, double lta_during_year, double actual_expenditure_lta, double d_lta,
				double ptax, int no_of_child, double d_education_allw, double uni_allw_during_year,
				...
				String bank_address, double total_c, double life_insurance, double ePF, double pPF, double nSC,
				double mF, double tuition_fees, double stamp_duty, double house_loan_principal,
				...
				double d_parents, double a_health_checkup, double d_health_checkup, double a_mediclaim,
				...
				double education_loan, double total_80egd, double total_f, double tax, double tax_remit,
				double total_tax, double edu_cess, double total_h, double tax_paid, double tax_payable,
				double payable_total_f, double payable_tax, double payable_tax_remit, double payable_total_tax,
				double payable_edu_cess, double payable_total_h, double april, double may, double june, double july,
				double august, double september, double october, double november, double december, double january,
				double february, double march, TDSBean tdsBean, EmployeeBean employeeBean) {
			super();
			this.status = status;
		...
		@Id
		@Column(name="tds_history_id")
		@GeneratedValue
		public int getTds_history_id() {
			return tds_history_id;
		}

		public void setTds_history_id(int tds_history_id) {
			this.tds_history_id = tds_history_id;
		}
