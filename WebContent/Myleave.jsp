...
<script type="text/javascript">
		...
		<div class="content-wrapper">
			...
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header" align="Center"> My Leave</h1>
				</div>
			</div>
			<br>
			...
			<div class="row">
				    <div class="col-md-12">
						...
						<div class="panel-body">
							...
							<form action="LeaveApprovedUpdate" method="post"  id="temp">
							<%}else{ %>
							<form action="LeaveRejectedUpdate" method="post" enctype="multipart/form-data" id="temp">
							<%} %>
								<table class="table table-stripped" border="0">
									<%if(leaveBean.getStatus().equals("rejected") || (leaveBean.getStatus().equals("Pending")) || (leaveBean.getStatus().equals("approved") && !date.after(r1)) ){%>
									<tbody>
								...
								<tbody>
									...
									<tbody>
										<tr>
											...
											<td>:</td>
											<td colspan="3"><font size="2px"><%= leaveBean.getEmployeeBean().getFirstname() %> <%= leaveBean.getEmployeeBean().getLastname() %></font></td>
									...
									<tr>
										...
										<th><font size="2px">Purpose Of Leave</font></th>
										<td>:</td>
										<td colspan="3"><font size="2px"><%= leaveBean.getPurpose_of_Leave() %></font></td>
									...
									<tbody>
									<tr>
										<th><font size="2px">Leave Applied For</font></th>
										<td>:</td>
										<%
										...
										<td colspan="2"><font size="2px"><%= FROM %> 
										<%String half1 = leaveBean.getFrom_half();
										if(half1.equalsIgnoreCase("FF")){
										%>
										(Full Day)
										<%}else if(half1.equalsIgnoreCase("FH")){ %>
										...
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
										<%= TO %> 
										<%String half2 = leaveBean.getTo_half();
										if(half2.equalsIgnoreCase("FF")){
										%>
										(Full Day)
										<%}else if(half2.equalsIgnoreCase("FH")){ %>
									    (First Half)
										<%}else if(half2.equalsIgnoreCase("SH")) {%>
										(Second Half)
										<%} %>
									...
									<td colspan="2"></td>									
									<TD colspan="2">
											<label>To Date   :   </label><%= TO %> (<%=leaveBean.getTo_half() %>)
								...
								<tbody>
									<tr>
										...
										<th><font size="2px"> Leave Day Count </font></th>
										<td>:</td>
										<td colspan="3"><font size="2px">
									...
									<tbody>
									<tr>
										<th><font size="2px">Contact Address </font></th>
										<td>:</td>
										<td colspan="3"><font size="2px"><%= leaveBean.getAddress() %></font></td>
									...
									<tbody>
									<tr>
										<th><font size="2px">Contact Number During Leave</font></th>
										<td>:</td>
										<td colspan="3"><font size="2px"><%= leaveBean.getNumber() %></font></td>
								</tr>
								<tbody>
								...
								<%} %>
 								...
 								<%if(leaveBean.getStatus().equals("rejected") || (leaveBean.getStatus().equals("Pending")) || (leaveBean.getStatus().equals("approved") && !date.after(r1))){ %>
	                            	...
	                            	<input type="hidden" name="redirect">
                                			<button class="btn btn-success" type="button" value="Submit" onclick="myFunction();">Update</button>
                                	...
                                	<tbody/>
                                	<tbody>
                                		<%if (leaveBean.getStatus().equals("Pending") || leaveBean.getStatus().equals("approved")){ %>
                                	...
                                	<div class="form-group has-error">
                                            ...
                                            <input type="text" class="form-control" value="<%= leaveBean.getReason() %>"  id="remarks" name="remarks" oninput="replica()" >
                                        </div>
                                        </td> 
                                        </tr> 
                                        <tbody/>
                           ...
                           <%
								...
								for(HolidayBean h : listgholiday)
								{
								 ...
								 for (String holydays : holiday){
									 //System.out.println("akash:"+holydays);
								 }
								%>
								</table>
							</form>
...
$(document).ready(function()
  ...
  function check()
  {
  	...
  	if( x == null){
		...
		window.location.replace("Myleave?leave_id="+id+"&status=approved");
