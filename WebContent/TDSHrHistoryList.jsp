<%@page import="com.hrms.tds.bean.TDSHrHistoryBean"%>
...
<body data-open="hover" data-menu="horizontal-menu" data-col="2-columns" class="horizontal-layout horizontal-menu 2-columns ">
	<% double TEX = 0.0; 
	int tds_hr_id = Integer.parseInt(request.getParameter("tds_hr_id"));
	
	TDSListDAO tdsListDAO = new TDSListDAO();
	TDSHrBean tdsHrBean = tdsListDAO.detailsOfTDSByHrId(tds_hr_id);
	%>
				    ...
				    <div class="col-md-12">
				        <div class="card">
				        	<div class="card-header">
					        	<div class="row">
						        	<div class="col-md-6">
						                <h4 class="card-title" id="horz-layout-basic">History Of <font color="blue"><%=tdsHrBean.getEmployeeBean().getFirstname() +" "+ tdsHrBean.getEmployeeBean().getLastname() %></font></h4>
						                <a class="heading-elements-toggle"><i class="icon-ellipsis font-medium-3"></i></a>
						            </div>
					            <div class="col-md-6" align="right">
		                        		<a href="TDSDemo.jsp">
		                        		<button type="button" class="btn mr-1 mb-1 btn-success btn-sm"><i class="icon-reply"></i> All List</button>
		                        		</a>
		                        </div>
		                        </div>
	                        </div>
								...
								<table class="table table-striped table-bordered file-export">
									<thead>
										<tr>
											...
											<th id="tableHeadingPadding">Employee Code</th>
									...
									<tbody>
										...
										<% 
												...
												List<TDSHrHistoryBean> listOfTDSHrHistoryData  = tdsListDAO.getDetailTDSHrHistoryById(tds_hr_id);
												for(TDSHrHistoryBean tds : listOfTDSHrHistoryData){
				                                %>

										<tr>
											<td id="historyTable"><%=tds.getEmployeeBean().getFirstname()%> <%=tds.getEmployeeBean().getLastname()%></td>
											<td id="historyTable"><%=tds.getEmployeeBean().getEmployee_code() %></td>
											...
											<td class="hide"><%=tds.getAnnual_gross_salary()%></td>
