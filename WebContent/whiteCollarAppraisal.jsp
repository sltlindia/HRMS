...
<div class="app-content container center-layout mt-2">
		<div class="content-wrapper">
		 		...
		 		<div class="panel-body" id="panelbody">
                            <div class="alert alert-dismissable alert-danger ">
                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                 ${yearExist}${monthExist}${quarterExist} <i class="icon-edit2" data-toggle="tooltip" data-placement="top" title="Show Appraisal Data"></i>
                            </div>
          		</div>  
          		<%} %>
          		<div class="row">
			...
			<!-- <div class="row">
				...
				<input type="hidden" name="whiteCollar" value="1">
				<div class="row">
				    <div class="col-md-12">
				        <div class="card box-shadow-0" data-appear="appear">
													...
													<table class="table table-striped">
														<tbody>
															<tr>
																<th>Employee Name</th>
																<td>:</td>
																<td><%=user.getFirstname()+" "+user.getMiddlename()+" "+user.getLastname()%>	
															</tr>
														</tbody>
														...
														<tbody>
															<tr>
																<th>Designation</th>
																<td>:</td>
																<td><%=user.getRoleBean().getRole_type()%></td>
															</tr>
														</tbody>
														...
														<tbody>
															<tr>
																<th>Department</th>
																<td>:</td>
																<td><%=user.getDepartmentBean().getDepartment_name()%></td>
															</tr>
														</tbody>
														<tbody>
															<tr>
