						...
						<div class="panel-body">
							...
							<%} %>
								<table class="table table-stripped" border="0">
									...
									<tr>
										...
										if(half.equalsIgnoreCase("FF")){%>
											<input  type="radio" id="7" name="leavefromDate" value="FF" onchange="check();"  checked="checked"> Full Day
										<%}else{ %>
											<input  type="radio" id="7" name="leavefromDate" value="FF" onchange="check();"> Full Day
										<%} %>	
										
										<%if(half.equalsIgnoreCase("FH")){%>
											<input id="1" type="radio" name="leavefromDate" value="FH" checked="checked" onchange="check();"> First Half
										<%}else{%>
											<input id="1" type="radio" name="leavefromDate" value="FH" onchange="check();"> First Half
										<%} %>
										
										<%if(half.equalsIgnoreCase("SH")){%>
											<input id="2" type="radio" name="leavefromDate" value="SH" checked="checked" onchange="check();"> Second Half
										<%}else{%>
											<input id="2" type="radio" name="leavefromDate" value="SH" onchange="check();"> Second Half
										<%} %>		
									</div>
									</td>
									</tr>
								...
								<tbody>
	                            	...
	                            	<input type="hidden" name="action" id="action" value="hrSide">
...
$(document).ready(function()
  ...
  function check()
  {
  	...
  	if( x == null){
			...
			var id = document.getElementById('lid').value;
			window.location.replace("Myleave?leave_id="+id+"&status=approved&action=hrSide");
