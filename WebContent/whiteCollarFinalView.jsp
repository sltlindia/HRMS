		...
		<div id="page-wrapper">
         ...
         <div class="row">
				    <div class="col-md-12">
                            ...
                            <div class="panel-group" id="accordion">
                                <div class="panel panel-default">
									...
									<tr>
										...
										<div id="avef<%=i%>"><input type="text" value="<%=aveSec1%>" name="score" class="form-control"></div>
										<%} else if(a.getAppraisal_criteria_manager_id() == 1){
											obtain = (aveGoal * a.getWeightage()) / 5;
										%>
										<div id="ave<%=i%>"><%=aveGoal %></div>
										<div id="avef<%=i%>"><input type="text" value="<%=aveGoal %>" name="score" class="form-control"></div>
										<%} else if(a.getAppraisal_criteria_manager_id() == 2){
											obtain = (aveWork * a.getWeightage()) / 5;
										%>
										<div id="ave<%=i%>"><%=aveWork %></div>
										<div id="avef<%=i%>"><input type="text" value="<%=aveWork %>" name="score" class="form-control"></div>
										<%} %>
										</td>
									...
									boolean result = allUpdateDAO.appraisalperUpdate(total1, appraisal_id);
									...
									<%AllUpdateDAO allUpdateDAO = new AllUpdateDAO();
									boolean result = allUpdateDAO.appraisalperUpdate(totalPer, appraisal_id);
                                            ...
                                            <center>Goals</center>
												...
												<div class="table-responsive">
													...
													<thead>	
														<tr>
														<th></th>
														<th colspan="3"><h5><center><b>To be completed by Employee / Appraisee</b></center></h5></th>
														<th colspan="3"><h5><center><b>To be completed by HOD / Appraiser</b></center></h5></th>
														</tr>
													</thead>
													<tbody>
													<tr>
                               ...
                               <hr>
								...
								<div class="panel-body">
									...
									<textarea class="form-control" name="contributions" disabled="disabled"><%=appraisalWhiteCollarSection2Bean.getMajor_accomplishments() %></textarea>
									<br>
									<div class="tooltip-demo">
										<label>
									...
									<textarea class="form-control" name="obstacles" disabled="disabled"><%=appraisalWhiteCollarSection2Bean.getOpportunities_for_development() %></textarea>
									<br>
									<div class="tooltip-demo">
										<label>
									...
									<textarea class="form-control" name="opportunities" disabled="disabled"><%=appraisalWhiteCollarSection2Bean.getJob_assignment()	 %></textarea>
                                      <br>
									...
									<%} %>
										...
										<div class="table-responsive">
													...
													<thead>	
														...
														<th><center><h5><b>Rating(1 to 5)</b></i></a></h5> <a href="" data-toggle="modal" data-target="#myModal"><i class="glyphicon glyphicon-info-sign"  data-toggle="tooltip" data-placement="top" title="Description"></center></th>
														</tr>
													</thead>
													<tbody>
													<%
                      ...
                      <a href="printWhite.jsp?appraisal_id=<%=appraisal_id%>"><input type="button" class="btn btn-default" name="submit" value="PRINT"></a>
                    <!-- /.panel -->
                </div>
