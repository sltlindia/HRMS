           ...
           <div class="row">
				    <div class="col-md-12">
                        ...
                        <div class="panel-body">
                            <div class="panel-group" id="accordion">
                                <div class="panel panel-default">
									...
									<tr>
										...
										<div id="avef<%=i%>"><input type="text" value="<%=a.getAppraisalGradeBean().getAppraisal_grade_id()%>" name="score" class="form-control"></div>
										</td>
									...
									<tr>
										...
										<div id="avef9"><input type="text" value="<%=aveSec1%>" name="score" class="form-control"></div>
										</td>
									...
									boolean result = allUpdateDAO.appraisalperUpdate(totalAve, appraisal_id);
                            ...
                            <hr>
                            <a href="allAppraisal.jsp"><input type="button" class="btn btn-default" name="submit" value="Go to History"></a>
                      
                      		<a href="printBlue.jsp?appraisal_id=<%=appraisal_id%>"><input type="button" class="btn btn-default" name="submit" value="PRINT"></a>
                    </div>
                </div>
            </div>
