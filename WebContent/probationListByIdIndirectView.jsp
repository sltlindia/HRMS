...
Jsp for getting data from manager after rejection of manager's view
...
if (authority.equals("W1") || authority.equals("W2") || authority.equals("W3")
 ...
 %>
								...
								<%
									...
									List<ProbationAssessmentManagerBean> listOfScore = allListProbationDAO.getListOfScoreById(emp_id,
 ...
 %>
													<div class="form-group">
														<label class="radio-inline"> <input type="radio"
															...
															name="extended1" id="extended" value="extendedNo" checked
															disabled="disabled">No </label>
													</div> <%
 	}
 %>
											...
											<tr>
												...
												<td>
													...
													<div class="form-group">
														<label class="radio-inline"><input type="radio"
															name="terminated1" id="terminated" value="terminatedYes"
															checked disabled="disabled">Yes </label> <label
															class="radio-inline"><input type="radio"
 ...
 %>
													<div class="form-group">
														<label class="radio-inline"><input type="radio"
															name="terminated1" id="terminated" value="terminatedYes"
															disabled="disabled">Yes </label> <label
															class="radio-inline"><input type="radio"
															name="terminated1" id="terminated" value="terminatedNo"
															checked disabled="disabled">No </label>
													</div> <%
 ...
 %>
								...
								<div class="col-lg-6">
									<div class="panel-heading">
										<h5>Reporting Manager's Remarks</h5>
									</div>
							...
							<center>
								...
								<a href="probationFormApprovalManager.jsp"><input
									type="button" value="Back" class="btn btn-primary"></a>
