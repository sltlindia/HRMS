...
=======
    <title>Aakash</title>
>>>>>>> adfc1b2c543c79ce9e0f951b59a9eb196a01b37d
          ...
          <li data-menu="dropdown" class="dropdown nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link"><i class="icon-wpforms"></i><span data-i18n="nav.category.forms">Forms</span></a>
            <ul class="dropdown-menu">
              ...
              <li data-menu="dropdown-submenu" class="dropdown dropdown-submenu"><a href="#" data-toggle="dropdown" class="dropdown-item dropdown-toggle">Form Wizard</a>
                <ul class="dropdown-menu">
                  <li data-menu="" class="active"><a href="form-wizard-circle-style.html" data-toggle="dropdown" class="dropdown-item">Circle Style</a>
                  </li>
      ...
      <div class="content-wrapper">
        <div class="content-header row">
          ...
          <div class="content-header-lead col-xs-12 mt-2">
            <p class="lead">Add .wizard-circle class to form tag to apply circle style wizard steps. This is the default style with circle wizard steps. There are two styles to display wizard tabs horizontal and vertical. You can display numbers or icons as wizard steps. You can also validate form fields on each wizard step.</p>
          </div>
        </div>
...
<!-- Mirrored from pixinvent.com/bootstrap-admin-template/robust/html/ltr/horizontal-menu-template/form-wizard-circle-style.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Aug 2017 08:52:05 GMT -->
</html>
