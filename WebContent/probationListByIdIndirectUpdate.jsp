...
Jsp for getting data from manager after rejection of manager's review update 
					...
					<div class="col-lg-12">
						<div class="panel panel-primary">
							<div class="panel-heading">
								<b><font size="3px">Probation Confirmation Assessment Form</font></b>
							</div> -->
			...
			<!-- <div class="row">
				<div class="col-lg-12">
					<div class="panel panel-primary">
						...
						<form action="probationIndirectManagerReviewUpdate" method="POST">
							<input type="hidden" name="employee_master_id"
								value="<%=emp_id%>"> <input type="hidden"
								name="transfer" value="manager1">
							<div class="panel-body">
								<div class="table-responsive">
...
if (authority.equals("W1") || authority.equals("W2") || authority.equals("W3")
 ...
 %>
												...
												<td style="width: 100px;"><input type="hidden"
													name="month_id"
													value="<%=m.getMonth_id()%>"><input type="text"
													class="form-control" name="month_score"
													id="month_score<%=i%><%=k%>"
...
<tr>
								...
								<%
									...
									String period_to_be_extend = null;
									...
									for (ProbationAssessmentManagerBean score : listOfScore) {
										...
										to_be_extended = Integer.parseInt(score.getPeriod_to_be_extended());
										int probationmanager_id = score.getProbation_assessment_manager_id();

										ProbationExtendBean probationExtendBean = allListProbationDAO
												.getListOfProbationPending(probationmanager_id);
										period_to_be_extend = probationExtendBean.getExtended_period();
								%>
								<div class="col-lg-6">
									<div class="panel-heading">
									...
									<input type="hidden"
										value="<%=score.getProbation_assessment_manager_id()%>"
										name="probation_assessment_manager_id">
												...
												<td>
													...
													<div class="form-group">
														<label class="radio-inline"><input type="radio"
															...
															onclick="check(this.id)" checked>Yes </label><label
															class="radio-inline"><input type="radio"
															name="confirmed" id="confirmedNo" value="confirmedNo"
															onclick="check(this.id)">No </label>
													</div> <%
 	} else {
 %>
													<div class="form-group">
														<label class="radio-inline"> <input type="radio"
															...
															name="confirmed" id="confirmedNo" value="confirmedNo"
															onclick="check(this.id)" checked>No </label>
													</div> <%
 	}
 %>
												</td>
											...
											<tr>
												...
												<td>
													...
													<div class="form-group">
														<label class="radio-inline"> <input type="radio"
															name="extended" id="extendedYes" value="extendedYes"
															onclick="check(this.id)" checked>Yes
														</label> <label class="radio-inline"><input type="radio"
															name="extended" id="extendedNo" value="extendedNo"
															onclick="check(this.id)">No </label>
													</div> <%
 	} else {
 %>
													<div class="form-group">
														<label class="radio-inline"> <input type="radio"
															...
															name="extended" id="extendedNo" value="extendedNo"
															checked onclick="check(this.id)">No
														</label>
													</div> <%
 	}
 %>
												...
												<td>
													...
													<div class="form-group">
														<label class="radio-inline"><input type="radio"
															...
															value="terminatedYes" onclick="check(this.id)" checked>Yes
														</label> <label class="radio-inline"><input type="radio"
															name="terminated" id="terminatedNo" value="terminatedNo"
															onclick="check(this.id)">No </label>
													</div> <%
 	} else {
 %>
 ...
 %>
								...
								<div class="col-lg-6">
									...
									<textarea rows="7" cols="90" class="form-control"
										name="remarks1" placeholder="Enter Your Remarks:" required><%=score.getRemarks()%></textarea>
								</div>
								<%if(!score.getTo_be_extended().equalsIgnoreCase("extendedYes")){%>
								<script type="text/javascript">
								$(document).ready(function() {
								...
								<div class="col-lg-12">
									...
									<%
										if (period_to_be_extend.equalsIgnoreCase("2")) {
									%>
									...
									<div class="form-group" id="period_extend">
										<label>Choose periods to be extended</label> <label
											class="radio-inline"> <input type="radio"
											name="extended_period" id="2months" value="2">2
											months
										</label> <label class="radio-inline"> <input type="radio"
											name="extended_period" id="4months" value="4" checked>4
											months
										</label>
									</div>
									<%
								...
								<div class="col-lg-12">
									<label>Total Period To be Extended : <%=to_be_extended%>
									</label>
								</div>
								<%
