...
<div class="app-content container center-layout mt-2">
		<div class="content-wrapper">
			...
			<div class="row">
				<div class="col-lg-12">
				<br>
					<center><h3>Goals Weightage: 70%</h3>
					<h4>(The sum of the weightage should be 100%)</h4>
					<hr>
				</div>
			</div>
<!-- <div id="wrapper">
				...
				<input type="hidden" name="appraisal_id" value="<%=request.getParameter("appraisal_id")%>">
							<div class="panel-group" id="accordion">
									<div id="collapseOne" class="panel-collapse collapse in">
										<div class="panel-body">
												<div class="table-responsive">
													...
													<tr>
														...
														<td><input type="text" name="weightage" class="form-control" value="<%=appraisalWhiteCollarGradeBean.getWeightage()%>"></td>
														<td><input type="text" name="a_cmt" class="form-control" value="<%=appraisalWhiteCollarGradeBean.getAppraiser_comment()%>"></td>
										...
										if(appraisalWhiteCollarGradeBean.getAppraisalGradeBean().getAppraisal_grade_id() == g.getAppraisal_grade_id()){
										%>
