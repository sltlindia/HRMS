		...
		<div class="content-wrapper">
			...
			<div class="row">
				    <div class="col-md-12">
				        ...
				        <div class="card box-shadow-0" data-appear="appear">
					        <div class="card-header card-inverse" style="background-color: #90A4AE;padding: 0.5rem 0rem 1rem 0rem;height: 50px;">
					            <div class="col-sm-6">
				               		<h4 class="card-title" id="horz-layout-basic">Employee Reports</h4>
				                </div>
				            </div>
					...
					AllListDAO allListDAO = new AllListDAO();
						List<EmployeeBean> listOfEmployee = allListDAO.underManagerList(manager_id);
						for(EmployeeBean e : listOfEmployee){
						int under_manager_id = e.getManagerBean().getManager_id();
						%>
											<tr>
												<td><%=e.getFirstname()+" "+e.getLastname() %></td>
												<td><%=e.getRoleBean().getRole_type() %></td>
												<td><a href="reportOfEmployee.jsp?employee_id=<%=e.getEmployee_master_id()%>&name=<%=e.getFirstname()+" "+e.getLastname()%>"><i class="icon-history2"></i></a></td>
												
											</tr>
											
												<%
												List<EmployeeBean> listOfEmployee1 = allListDAO.underManagerList(under_manager_id);
												for(EmployeeBean e1 : listOfEmployee1){
						%>
												<tr>
												<td><%=e1.getFirstname()+" "+e1.getLastname() %></td>
												<td><%=e1.getRoleBean().getRole_type() %></td>
												<td><a href="reportOfEmployee.jsp?employee_id=<%=e1.getEmployee_master_id()%>&name=<%=e1.getFirstname()+" "+e1.getLastname()%>"><i class="icon-history2"></i></a></td>
											</tr>
												<%} }%>
