			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-primary">
						<div class="panel-heading">Rejected TimeSheet</div>
						<!-- /.panel-heading -->
						<div class="panel-body">
							<div class="dataTable_wrapper">
								<table class="table table-striped table-bordered table-hover zero-configuration">
									...
									<tbody>
											<%
												List<Object[]> rejectedEmployeeTimeSheet = (ArrayList)request.getAttribute("rejectedEmployeeTimeSheet");
												for (Object[] aRow : rejectedEmployeeTimeSheet) {
												String d = null;
											...
											<td><%=d %></td>
												...
												<td><%=employeeBean.getFirstname()%> <%=employeeBean.getLastname() %>
											</tr>
											<%
													}
												%>
