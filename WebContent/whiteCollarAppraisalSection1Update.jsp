...
<!-- <div id="wrapper">
		<div id="page-wrapper">
			...
			<div class="row">
				...
				<form action="whiteCollarSection1Update" method="get" name="">
				...
				<input type="hidden" name="year_id" value="<%=request.getParameter("year_id")%>">
				<div class="card">
							...
							<div class="panel-group" id="accordion">
								<div class="panel panel-default">
								  ...
								  List<AppraisalWhiteSection1Bean> listOfAppraisal = allListDAO.getappraisalSection1(appraisal_id);
									...
									<input type="hidden" name="appraisalWhiteSection1Id" id="appraisalWhiteSection1Id" value="<%=appraisalWhiteSection1Bean.getAppraisal_white_section1_id() %>">
									<div class="panel-heading">
										<h4 class="panel-title">
											Describe your key roles & responsibility in the organization
										</h4>
									</div>
									<textarea class="form-control" rows="6" name="roles" placeholder="max 1000 words" required="required"><%=appraisalWhiteSection1Bean.getRoles_Responsibility()%></textarea>
									<div class="panel-heading">
										<h4 class="panel-title">
											List out your major contributions / achievements this year (Other than goals/objectives)
										</h4>
									</div>
									<textarea class="form-control" rows="6" name="contributions" placeholder="max 1000 words" required="required"><%=appraisalWhiteSection1Bean.getContribution_achievememt()%></textarea>
									<div class="panel-heading">
										<h4 class="panel-title">
											What are the obstacles you have found in your growth?
										</h4>
									</div>
									<textarea class="form-control" rows="6" name="obstacles" placeholder="max 1000 words" required="required"><%=appraisalWhiteSection1Bean.getObstacles()%></textarea>
									<div class="panel-heading">
										<h4 class="panel-title">
									...
									<textarea class="form-control" rows="6" name="opportunities" placeholder="max 1000 words" required="required"><%=appraisalWhiteSection1Bean.getOpportunities()%></textarea>
									   <%} %>
								</div>
							</div>
	<br>
