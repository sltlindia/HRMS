...
<!-- <div id="wrapper">
		<div id="page-wrapper">
			...
			<div class="row">
				...
				<form action="whiteCollarSection3Update" method="get">
				<input type="hidden" name="appraisal_id" value="<%=appraisal_id%>">
							<div class="panel-group" id="accordion">
								<div class="panel panel-default">
									<div class="panel-heading">
										<h4 class="panel-title">
											<a data-toggle="collapse" data-parent="#accordion"
												href="#collapseOne">3A - Appraisee's Comments:</a>
										</h4>
									</div>
									 <%
									...
									<textarea class="form-control" rows="6" name="a_cmt"><%=a.getEmp_comment()%></textarea>
									<%} %>
									</div> 
									</div>
									<input type="hidden" name="employee_done" value="employee_done">
									<br>
									<center>
									<input type="submit" value="Finish" class="btn btn-primary"></a>
