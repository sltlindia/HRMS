								...
								<div class="row">
									<div class="col-lg-12">
										<div class="panel panel-primary">
											...
											<div class="panel-body">
												<form action="LeaveOd" method="post"
													...
													<table class="table table-stripped" border="0">
														...
														<tbody>
															<tr>
																...
																<td colspan="3"><input type="text" id="datepicker1"
																	width="155" name="StartDate" placeholder="dd/mm/yyyy"
														...
														<tbody>
															<tr>
																...
																<td>:</td>
																<td colspan="3"><input type="text" id="datepicker2"
																	width="155" name="EndDate" placeholder="dd/mm/yyyy"
														...
														<tbody>
															<tr>
																<th><label>Start Time</label>
																	<p class="help-block">(Not Required)</p></th>
																<td>:</td>
														...
														<tbody>
															<tr>
																...
																<td colspan="3"><input id=endtime type="text"
																	class="form-control" name="endtime" placeholder="HH:mm"
																	required />
															</tr>
														</tbody>
														<tbody>
															<tr>
																...
																<td colspan="3"><input type="text"
																	class="form-control" rows="3" id="numdays2"
																	name="numdays" placeholder="Total Days" required
																	readonly></input> <input type="hidden" id="SundayCO"
																	name="SundayCO" value=""> <input type="hidden"
																	id="holidayCO" name="holidayCO" value=""> <input
																	type="hidden" id="coDates" name="coDates" value="">
