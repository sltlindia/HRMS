...
<div class="app-content container center-layout mt-2">
		<div class="content-wrapper">
			...
			<div class="row">
				...
				<form action="workGradeUpdate" method="post" enctype="multipart/form-data">
										...
										<div class="panel-body">
												...
												List<WorkGradeBean> listOfWorkGrade = allListDAO.getListOfWorkGrade(appraisal_id);
													for(int i=0;i<listOfWorkGrade.size();i++){
														WorkGradeBean w = listOfWorkGrade.get(i);
													%>
													
													<input type="hidden" name="work_grade_id" value="<%=w.getWork_grade_id()%>">
													<input type="hidden" name="work_id" value="<%=w.getWorkBehaviourBean().getWork_behaviors_id()%>">
													<tr>
														<td width="5%"><font size="3"><center><%=i+1%></center></font></td>
														<td><b><font size="3"><%=w.getWorkBehaviourBean().getWork_behaviors_name()%></font></b><br>
														<font size="2"><%=w.getWorkBehaviourBean().getWork_behaviors_desc()%></font><br>
														</td>
														<td width="15%">
														<select class="form-control" name="grade_id" required="required" style="width: 200px">
																			...
																			if(w.getAppraisalGradeBean().getAppraisal_grade_id() == g.getAppraisal_grade_id()){
																			%>
