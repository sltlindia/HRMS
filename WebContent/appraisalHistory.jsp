				    ...
				    <div class="col-md-12">
				        ...
				        <div class="card box-shadow-0" data-appear="appear">
					        <div class="card-header card-inverse" style="background-color: #90A4AE;padding: 0.5rem 0rem 1rem 0rem;height: 50px;">
					            <div class="col-sm-6">
				               		<h4 class="card-title" id="horz-layout-basic"> Appraisal History</h4>
				                </div>
				            </div>
                            ...
                            <div class="dataTable_wrapper"> -->
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                   ...
                                   <%
                                        	  ...
                                        	  List<AppraisalBean> listOfAppraisal = allListDAO.getAllappraisalByEmployeeId(emp_id);
                                        ...
                                        <%}else{%>
                                        <%  List<AppraisalWhiteSection1Bean> listOfAppraisal1 = allListDAO.getappraisalSection1(a.getAppraisal_id());
                                        if(listOfAppraisal1.size() != 0){
                                        %>
                                         <a href="whiteCollarAppraisalSection1Update.jsp?appraisal_id=<%=a.getAppraisal_id()%>&&year_id=<%=a.getYearBean().getYear_id()%>"><i class="icon-edit2" data-toggle="tooltip" data-placement="top" title="Show Appraisal Data"></i></a>
                                       <% }else{%>
                                    	   
                                    	   <a href="whiteCollarAppraisalSection1.jsp?appraisal_id=<%=a.getAppraisal_id()%>&&year_id=<%=a.getYearBean().getYear_id()%>"><i class="icon-edit2" data-toggle="tooltip" data-placement="top" title="Show Appraisal Data"></i></a>
                                 ...
                                 <h5><b>Legends :&nbsp;</b></h5>&nbsp;&nbsp;&nbsp;<i class="icon-edit2" style="color:#337ab7;"></i><b> : Edit Appraisal </b> &nbsp;&nbsp;&nbsp;<i class="icon-eye4" style="color:#337ab7;"></i><b> : View Appraisal </b>
                                </div>
