...
if(request.getParameter("company") != null){
	cmp_id = Integer.parseInt(request.getParameter("company"));
}
        ...
        <div class="col-xs-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Company Wise Employee List</h4>
...
<form action="employeeListCompanyWise.jsp" method="get">                        
<table class="table">
<tr>
...
<td>
	...
	<%} %>
	<%List<CompanyListBean> listOfCompany = allListDAO.getListOfCompany(); 
	for(CompanyListBean c : listOfCompany){
			if(c.getCompany_list_id() == cmp_id){
	%>
	<option value="<%=c.getCompany_list_id()%>" selected="selected"><%=c.getCompany_name()%></option>
	<%}else{ %>
	<option value="<%=c.getCompany_list_id()%>"><%=c.getCompany_name()%></option>
	<%} %>
	<%} }%>
	</select>
	</td>
                                ...
                                <table class="table table-striped table-bordered file-export">
                                   ...
                                   if(cmp_id == 0){
                                	   getemployeeList = allListDAO.getListOfAllEmployeeAllocation();  
                                		   ...
                                		   getemployeeList = allListDAO.getListOfEmployeeByCompany(cmp_id); 
                                   }
									...
									%>
                                        ...
                                        <td class="hidden"><%=e.getCompanyListBean().getCompany_name()%></td>
