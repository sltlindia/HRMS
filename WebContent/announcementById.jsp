	...
	<div class="app-content container center-layout mt-2">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <b>Broadcast By: <%=a.getEmployeeBean().getFirstname() + " " + a.getEmployeeBean().getLastname()%></b>
                </div>
            </div>
          ...
          <%} %>
            <div class="card-body collapse in">
                <div class="card-block">
                    <div class="card-text">
                       <!--  <p>Description lists with right aligned text in <code>&lt;dt&gt;</code> tag using <code>.text-xs-right</code></p> -->
                       <%--  <dl class="row">
                        <%
							int announcement_id = Integer.parseInt(request.getParameter("announcement_id"));
						%>
						...
						for (AnnouncementBean a : listOfAnnouncement) {
														%>
                            <dt class="col-sm-3 text-xs-left">Title</dt>
                            <dd class="col-sm-9"><%=a.getAnnouncement_title()%></dd>
                            <dt class="col-sm-3 text-xs-left">Description</dt>
                            <dd class="col-sm-9"><%=a.getAnnouncement_description()%></dd>
                            <dt class="col-sm-3 text-xs-left">Broadcast By</dt>
                            <dd class="col-sm-9"><%=a.getEmployeeBean().getFirstname() + " " + a.getEmployeeBean().getLastname()%></dd>
                          <!--   <dd class="col-sm-9">Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus.</dd>
                            <dt class="col-sm-3 text-xs-right">Nesting</dt> -->
 							<%} %>
                             <!-- <dd class="col-sm-9">
                                <dl class="row">
									...
									<div class="col-lg-12">
										<div class="panel panel-primary">
											<div class="panel-heading">
												<h4 align="left">Broadcast Details</h4>
											</div>
