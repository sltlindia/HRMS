...
<div class="row">
															...
															<table
																...
																e1.printStackTrace();
																	...
																	<tr>
																		...
																		<td><%if(timeSheetBean1.getTaskMasterBean().getTask_master_id() != 0){%>
																	<%=timeSheetBean1.getTaskMasterBean().getTask_master_name()%>
																	<%}else{ %>
																	<font color="red"><%=timeSheetBean1.getExternal_task_name()%></font>
																	<%} %></td>
											...
											<% if(comment.equalsIgnoreCase("")){%>
												<textarea class="form-control"
													name="m" id="comment" oninput="replica()" readonly="readonly">No Comments</textarea>
											<%}else{ %>
												<textarea class="form-control" rows="3"
													name="m" id="comment" oninput="replica()" readonly="readonly"><%=comment%></textarea>
											<%} %>
										</div>
															<a href="managerTimeSheetDefault"><center><input type="button" value="BACK" class="btn btn-primary"></center></a>
														</div>
													</div>
												</div>
											</div>
