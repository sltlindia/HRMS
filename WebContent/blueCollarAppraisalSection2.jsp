...
<div class="app-content container center-layout mt-2">
		<div class="content-wrapper">
			...
			<div class="row">
				...
				<form action="appraisalSection2Insert" method="post" enctype="multipart/form-data">
								...
								<div class="panel panel-default">
									...
									<thead>
													<tr>
														...
														<th colspan="2"><center>Ratings <a href="" data-toggle="modal" data-target="#myModal"><i class="glyphicon glyphicon-info-sign"  data-toggle="tooltip" data-placement="top" title="Description"></i></a></center></th>
									...
									<tbody>
									<tr>
										<td><input type="hidden" name="appraisal_criteria_id" value="<%=a.getAppraisal_criteria_id()%>"><%=a.getAppraisal_criteria_name()%></td>	
										<td>
										...
										<td>
										<a href="" data-toggle="modal" data-target="#myModal<%=a.getAppraisal_criteria_id()%>"><i class="glyphicon glyphicon-info-sign"  data-toggle="tooltip" data-placement="top" title="Description"></i></a>
										</td>
									 ...
									 <div class="modal fade" id="myModal<%=a.getAppraisal_criteria_id()%>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="myModalLabel"><%=a.getAppraisal_criteria_name() %></h4>
                                        </div>
										<%
										int id = a.getAppraisal_criteria_id();
                                ...
                                <!-- /.modal-dialog -->
									...
									<!-- /.panel-body -->
										<div class="tooltip-demo">
                                            ...
                                            <textarea class="form-control" name="achivements" id="achivements" value="" placeholder="max 500 words"></textarea>
                                        <br>
                                        <div class="tooltip-demo">
                                            ...
                                            <textarea class="form-control" name="improvement" id="improvement" value="" placeholder="max 500 words"></textarea>
										<br>
										<div class="tooltip-demo">
                                            <label>Employee's Comments</label>
                                            </div>
                                            <textarea class="form-control" name="employeeComments" id="employeeComments" value="" placeholder="max 500 words"></textarea>
                                       	<br>
                                        <div class="tooltip-demo">
                                            <label>Appraiser's Comments</label>
                                   			 
                                            </div>
											<textarea class="form-control" name="appraiserComments" id="appraiserComments" value="" placeholder="max 500 words"></textarea>                                           
                                           <br> 
										<div class="tooltip-demo">
                                            <label>Reviewing's Comments</label>
                                   			<textarea class="form-control" name="reviewingComments" id="reviewingComments" value="" placeholder="max 500 words"></textarea>
                                            </div>
                                        <br>
                                        <br>
                                    <center>
