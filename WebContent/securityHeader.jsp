...
%>
	...
	<div class="navbar-wrapper">
		...
		<li data-menu="dropdown" class="dropdown nav-item"><a href="gatePassListSecurity.jsp" data-toggle="dropdown" class="dropdown-toggle nav-link"><i class="icon-home3"></i><span data-i18n="nav.dash.main">Gatepass & Interview Tracker</span></a>
            <ul class="dropdown-menu">
              <li data-menu=""><a href="gatePassListSecurity.jsp" data-toggle="dropdown" class="dropdown-item">Gate Pass</a>
              </li>
              <li data-menu=""><a href="addInterviewee.jsp" data-toggle="dropdown" class="dropdown-item">Interview Tracker</a>
            	</li>
            </ul>
          </li>
          
          	<li data-menu="dropdown" class="dropdown nav-item"><a href="gatePassListSecurity.jsp" data-toggle="dropdown" class="dropdown-toggle nav-link"><i class="icon-home3"></i><span data-i18n="nav.dash.main">Company Details</span></a>
            <ul class="dropdown-menu">
              <li data-menu=""><a href="companyAddressesSecurity.jsp" data-toggle="dropdown" class="dropdown-item">Company Details</a>
              </li>
              <li data-menu=""><a href="extentionNumberSecurity.jsp" data-toggle="dropdown" class="dropdown-item">Extension Number</a>
            	</li>
            	<li data-menu=""><a href="cugListSecurity.jsp" data-toggle="dropdown" class="dropdown-item">CUG List</a>
              </li>
            </ul>
          </li>
			</ul>
