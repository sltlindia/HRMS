...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
   ...
   <title>Leave List Manager</title>
                			...
                			<div class="card-header">
                    			<div class="card box-shadow-0" data-appear="appear">
					        		<div class="card-header card-inverse" style="background-color: #90A4AE;padding: 0.5rem 0rem 1rem 0rem;height: 50px;">
					            		<div class="col-sm-6">
				               				<h4 class="card-title" id="horz-layout-basic">Pending Leave / CO / OD List</h4>
				                		</div>
				            		</div>
...
<!-- File export table -->
            			...
            			<div class="card">
                			<div class="card-header">
                    			<div class="card box-shadow-0" data-appear="appear">
					        		<div class="card-header card-inverse" style="background-color: #90A4AE;padding: 0.5rem 0rem 1rem 0rem;height: 50px;">
					            		<div class="col-sm-6">
				               				<h4 class="card-title" id="horz-layout-basic">Pending Leave/CO/OD Status</h4>
				                		</div>
				            		</div>
							...
							<div class="card-block">
								<ul class="nav nav-tabs nav-linetriangle no-hover-bg">
									...
									<li class="nav-item dropdown"><a class="nav-link active"
										...
										onclick="changeHrApproval(3)"><i class="icon-eye4"></i>
											OD <span
						...
						+ l.getEmployeeBean().getLastname()%></td>
														...
														<h5>
															<b>Legends :&nbsp;</b>
																		...
																		<i
																			class="icon-eye4" data-toggle="tooltip"
																			data-placement="top" title="View Details" style="color: #3BAFDA;"></i><b>
															: Leave Approval </b>
														<%
															}
														%>
 ...
 %>
																		...
																		%>
																		<td><a
																			href="LeaveCOManagerShow?CO_ID=<%=c.getCO_ID()%>">
																		<i
																			class="icon-eye4" data-toggle="tooltip"
																			data-placement="top" title="View Details"></i>  </a></td>
																		<%
 ...
 %>
																			...
																			%>
																			<td><a
																				href="LeaveODManagerShow?OD_ID=<%=od.getOD_ID()%>">
																		<i
																			class="icon-eye4" data-toggle="tooltip"
																			data-placement="top" title="View Details"></i>  </a></td>
																			<%
															...
															<h5>
																<b>Legends :&nbsp;</b>
																		...
																		<i
																			class="icon-eye4" data-toggle="tooltip"
																			data-placement="top" title="View Details" style="color: #3BAFDA;"></i>  </i><b>
																: OD Approval </b>
															<%
																}
															%>
