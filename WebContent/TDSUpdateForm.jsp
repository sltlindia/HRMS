...
<script>
	...
	function showAttachment(value,attName) {
		//alert(attName);
		var Id = value;
		//alert(Id);
		if(Id != 0){
			$("#"+attName+"Attachment").show();
		}else{
			$("#"+attName+"Attachment").hide();
		}
	}
...
<script src="dist/js/dropzone1.js" type="text/javascript"></script>
...
<script type="text/javascript">
	function codeAddress()
	{
		$(document).ready(function() {
			...
			$("#NSCAttachment").hide();
			$("#MFAttachment").hide();
			$("#TuitionFeesAttachment").hide();
			$("#StampDutyAttachment").hide();
			$("#HouseLoanAttachment").hide();
			$("#FixDepositeAttachment").hide();
			$("#OtherAttachment").hide();
			$("#NPSAttachment").hide();
			$("#RGESSAttachment").hide();
			$("#MediclaimAttachment").hide();
			$("#Donation80GAttachment").hide();
			$("#Donation80GGCAttachment").hide();
		});
	...
	var LifeInsurance = 0, EPF = 0, PPF = 0, NSC = 0, MF = 0, TuitionFees = 0, StampDuty = 0, HouseLoanPrincipal = 0, TaxSaverFixDeposit = 0, Other = 0,TotalD = 0;
	function calculateSection80C() {
		...
		if ((isNaN(LifeInsurance)) || (isNaN(EPF)) || (isNaN(PPF))
			...
			document.getElementById("TotalD").value = TotalD.toFixed(2);
			 ...
			 TotalC = document.getElementById("TotalC").value;
			var totald = 0.0 ;
			if (TotalD >= 150000) {
	...
	{
		var total = 0.0, totalc = 0.0, totald = 0.0,  
		//alert("SSSHHHH");
						 ...
						 <div class="card-body collapse in">
	               			<div class="card-block">
								...
								<div class="row">
									...
									<input type="hidden" name="tdsId" id="tdsId" value="<%=t.getTds_id()%>"/>
																							...
																							<div class="modal-body">
																								<table class="table table-striped">
																									<tr>
																										...
																										<th id="modalPadding">Permissible Deducated Value</th>
							                                ...
							                                <table class="table-bordered" width="100%">
							                                	<tbody> 
							                                		<tr>
																		...
																		<th width="50px;"><center><a href="" data-toggle="modal" data-target="#IncomeModal" id="Income" onclick="changeName(this.id);"><i class="icon-upload22" title="Upload Income Document" style="color: black;font-size: 15px;"></i></a></center></th>
																	</tr>
							                                ...
							                                <table class="table-bordered" width="100%">
							                                	 <tbody>
							                                	 	<tr>
							                                				<th width="50px;"></th>
																			<th></th>
																			<th style="width: 180px;" id="tablePadding"><center><u>Declared Amount</u></center></th>
																			<th style="width: 180px;" id="tablePadding"><center><u>Actual Amount</u></center></th>
																			<th  width="50px;"></th>
							                                		</tr>
							                                        <tr>
																			...
																			<th><center><a href="" data-toggle="modal" data-target="#LICModal" id="LIC" onclick="changeName(this.id);"><i class="icon-upload22" title="Upload TDS Document" style="color: black;font-size: 15px;"></i></a></center></th>
																	</tr>
																			...
																			<th style="width: 180px;" id="tablePadding"><center>
																					<div class="input-group">
																						<span class="input-group-addon">Rs.</span> <input
																							...
																							value="<%=td.getEPF() %>" readonly="readonly" onchange="calculateSection80C();">
																					</div>
																				</center></th>
																			<th style="width: 180px;" id="tablePadding"><center>
																					<div class="input-group">
																						<span class="input-group-addon">Rs.</span> <input
																							type="text" class="form-control" name="EPFPayable" id="EPFPayable" readonly="readonly"
																							value="<%=td.getPayable_epf() %>">
																					</div>
																				</center></th>
																			<th><center><a href="" data-toggle="modal" data-target="#EPFModal" id="EPF" onclick="changeName(this.id);"><i class="icon-upload22" title="Upload EPF Document" style="color: black;font-size: 15px;"></i></a></center></th>
																	</tr>
																	...
																	<tr>
																			...
																			<th style="width: 180px;" id="tablePadding"><center>
																					<div class="input-group">
																						<span class="input-group-addon">Rs.</span> <input
																							...
																							value="<%=td.getPPF() %>" readonly="readonly" onchange="calculateSection80C();">
																					</div>
																				</center></th>
																			<th style="width: 180px;" id="tablePadding"><center>
																					<div class="input-group">
																			...
																			<th><center><a href="" data-toggle="modal" data-target="#PPFModal" id="PPF" onclick="changeName(this.id);"><i class="icon-upload22" title="Upload PPF Document" style="color: black;font-size: 15px;"></i></a></center></th>
																	</tr>
																	...
																	<tr>
																			...
																			<th style="width: 180px;" id="tablePadding"><center>
																					<div class="input-group">
																						<span class="input-group-addon">Rs.</span> <input
																							...
																							value="<%=td.getNSC() %>" readonly="readonly" onchange="calculateSection80C();">
																					</div>
																				</center></th>
																			<th style="width: 180px;" id="tablePadding"><center>
																					<div class="input-group">
																			...
																			<th><center><a href="" data-toggle="modal" data-target="#NSCModal" id="NSC" onclick="changeName(this.id);"><i class="icon-upload22" title="Upload NSC Document" style="color: black;font-size: 15px;"></i></a></center></th>
																	</tr>
																	...
																	<tr>
																			...
																			<th style="width: 180px;" id="tablePadding"><center>
																					<div class="input-group">
																						<span class="input-group-addon">Rs.</span> <input
																							...
																							value="<%=td.getMF() %>" readonly="readonly" onchange="calculateSection80C();">
																					</div>
																				</center></th>
																			<th style="width: 180px;" id="tablePadding"><center>
																					<div class="input-group">
																			...
																			<th><center><a href="" data-toggle="modal" data-target="#MFModal" id="MF" onclick="changeName(this.id);"><i class="icon-upload22" title="Upload MF Document" style="color: black;font-size: 15px;"></i></a></center></th>
																	</tr>
																			...
																			<th style="width: 180px;" id="tablePadding"><center>
																					<div class="input-group">
																						<span class="input-group-addon">Rs.</span> <input
																							...
																							id="TuitionFees" value="<%=td.getTuition_fees() %>" readonly="readonly" onchange="calculateSection80C();">
																					</div>
																				</center></th>
																			<th style="width: 180px;" id="tablePadding"><center>
																					<div class="input-group">
																						<span class="input-group-addon">Rs.</span> <input
																							type="text" class="form-control" name="TuitionFeesPayable"
																							id="TuitionFeesPayable" value="<%=td.getPayable_tuition_fees()%>" readonly="readonly">
																					</div>
																				</center></th>
																			<th><center><a href="" data-toggle="modal" data-target="#TuitionFeesModal" id="TuitionFees" onclick="changeName(this.id);"><i class="icon-upload22" title="Upload Tuition Fees Document" style="color: black;font-size: 15px;"></i></a></center></th>
																	</tr>
																			...
																			<th style="width: 180px;" id="tablePadding"><center>
																					<div class="input-group">
																						<span class="input-group-addon">Rs.</span> <input
																							...
																							id="StampDuty" value="<%=td.getStamp_duty() %>" readonly="readonly" onchange="calculateSection80C();">
																					</div>
																				</center></th>
																			<th style="width: 180px;" id="tablePadding"><center>
																					<div class="input-group">
																						<span class="input-group-addon">Rs.</span> <input
																							type="text" class="form-control" name="StampDutyPayable"
																							id="StampDutyPayable" value="<%=td.getPayable_stamp_duty()%>" readonly="readonly">
																					</div>
																				</center></th>
																			<th><center><a href="" data-toggle="modal" data-target="#StampDutyModal" id="StampDuty" onclick="changeName(this.id);"><i class="icon-upload22" title="Upload Stamp Duty Document" style="color: black;font-size: 15px;"></i></a></center></th>
																	</tr>
																	...
																	<tr>
																			...
																			<th style="width: 180px;" id="tablePadding"><center>
																					<div class="input-group">
																						<span class="input-group-addon">Rs.</span> <input
																							...
																							value="<%=td.getHouse_loan_principal() %>" readonly="readonly" onchange="calculateSection80C();">
																					</div>
																				</center></th>
																			<th style="width: 180px;" id="tablePadding"><center>
																					<div class="input-group">
																			...
																			<th><center><a href="" data-toggle="modal" data-target="#HouseLoanModal" id="HouseLoan" onclick="changeName(this.id);"><i class="icon-upload22" title="Upload House Loan Document" style="color: black;font-size: 15px;"></i></a></center></th>
																	</tr>
																			...
																			<th style="width: 180px;" id="tablePadding"><center>
																					<div class="input-group">
																						<span class="input-group-addon">Rs.</span> <input
																							...
																							value="<%=td.getTax_saver_deposite() %>" readonly="readonly" onchange="calculateSection80C();">
																					</div>
																				</center></th>
																			<th style="width: 180px;" id="tablePadding"><center>
																					<div class="input-group">
																						<span class="input-group-addon">Rs.</span> <input
																							type="text" class="form-control"
																							name="FixDepositePayable" id="FixDepositePayable"
																							value="<%=td.getPayable_fix_deposite()%>" readonly="readonly">
																					</div>
																				</center></th>
																			<th><center><a href="" data-toggle="modal" data-target="#FixDepositeModal" id="FixDeposite" onclick="changeName(this.id);"><i class="icon-upload22" title="Upload Fix Deposite Document" style="color: black;font-size: 15px;"></i></a></center></th>
																	</tr>
																				...
																				<div class="row">
																					...
																					<div class="col-lg-8">
																						<input type="text" class="form-control" name="OtherDocument" id="OtherDocument" placeholder="Please Specify"
																							value="<%=td.getOther_document() %>" style="border-radius: 4px;">
																					</div>
																				</div>
																			</th>
																			<th style="width: 180px;padding-top: 15px;"><center>
																					<br><br>
																					<div class="input-group">
																						<span class="input-group-addon">Rs.</span> <input
																							type="text" class="form-control" name="Other" id="Other"
																							value="<%=td.getOther() %>" onchange="calculateSection80C();" readonly="readonly">
																					</div>
																				</center></th>
																			<th style="width: 180px;padding-top: 15px;"><center>
																					<br><br>
																					<div class="input-group">
																						<span class="input-group-addon">Rs.</span> <input
																							type="text" class="form-control" name="OtherPayable" id="OtherPayable"
																							value="<%=td.getPayable_other()%>" readonly="readonly">
																					</div>
																				</center></th>
																			<th><br><br><center><a href="" data-toggle="modal" data-target="#OtherModal" id="Other" onclick="changeName(this.id);"><i class="icon-upload22" title="Upload Other Document" style="color: black;font-size: 15px;"></i></a></center></th>
																	</tr>
																			...
																			<th style="width: 180px;" id="tablePadding"><center>
																					<div class="input-group">
																						<span class="input-group-addon">Rs.</span> <input
																							...
																							id="TotalD" value="<%=td.getA_total_d() %>" readonly="readonly" readonly="readonly">
																					</div>
																				</center></th>
																			<th style="width: 180px;" id="tablePadding"><center>
																					<div class="input-group">
																	...
																	<tr>
																			...
																			<th style="width: 180px;" id="tablePadding"><center>
																					<div class="input-group">
																						<span class="input-group-addon">Rs.</span> <input
																							...
																							id="80CTotal" value="<%=td.getD_total_d() %>" readonly="readonly" readonly="readonly">
																					</div>
																				</center></th>
																			<th style="width: 180px;" id="tablePadding"><center>
																					<div class="input-group">
																			...
																			<th>
																			<!-- <center><a onclick="transferValue();" style="cursor: pointer;"><i class="glyphicon glyphicon-circle-arrow-left" title="CLICK HERE" style="color: black;font-size: 15px;"></i></a></center> -->
																			</th>
																	</tr>
																	...
																	<tr>
																		...
																		<th width="50px;">
																				...
																				<center><a href="" data-toggle="modal" data-target="#myModal9"><i class="icon-android-add-circle" title="CLICK HERE" style="color: black;font-size: 15px;"></i></a>
																					<a href="" data-toggle="modal" data-target="#NPSModal" id="NPS" onclick="changeName(this.id);"><i class="icon-upload22" title="Upload NPS Document" style="color: black;font-size: 15px;"></i></a>
																				</center>
																				<!-- Modal -->
																		...
																		<th>
																				...
																				<center><a href="" data-toggle="modal" data-target="#myModal10"><i class="icon-android-add-circle" title="CLICK HERE" style="color: black;font-size: 15px;"></i></a>
																					<a href="" data-toggle="modal" data-target="#RGESSModal" id="RGESS" onclick="changeName(this.id);"><i class="icon-upload22" title="Upload RGESS Document" style="color: black;font-size: 15px;"></i></a>
																				</center>
																				<!-- Modal -->
																		...
																		<th style="width: 180px;" id="tablePadding"><center>
																				<div class="input-group">
																					<span class="input-group-addon">Rs.</span> <input
																						...
																						id="PayabletotalE" value="" readonly="readonly">
																				</div>
																			</center></th>
																		<th></th>
																	</tr>
							                      ...
							                      <div class="col-lg-9">
							                            <div class="table-responsive">
							                                <table class="table-bordered" width="100%">
							                                	<tbody>
							                                        <tr>
							                                        	<th width="70px;"><center>1</center></th>
																		...
																		<th width="70px;">
																				...
																				<center><a href="" data-toggle="modal" data-target="#myModal12"><i class="icon-android-add-circle" title="CLICK HERE" style="color: black;font-size: 15px;"></i></a>
																					<a href="" data-toggle="modal" data-target="#MediclaimModal" id="Mediclaim" onclick="changeName(this.id);"><i class="icon-upload22" title="Upload Mediclaim Document" style="color: black;font-size: 15px;"></i></a>
																				</center>
																				<!-- Modal -->
							                                        ...
							                                        <tr>
																		...
																		<th>
																			...
																			<center><a href="" data-toggle="modal" data-target="#myModal13"><i class="icon-android-add-circle" title="CLICK HERE" style="color: black;font-size: 15px;"></i></a>
																					<a href="" data-toggle="modal" data-target="#Donation80GModal" id="Donation80G" onclick="changeName(this.id);"><i class="icon-upload22" title="Upload Donation Document" style="color: black;font-size: 15px;"></i></a>
																			</center>
																			<!-- Modal -->
							                                        ...
							                                        <tr>
																		...
																		<th>
																			<!-- Button trigger modal -->
																			<center>
																			<a href="" data-toggle="modal" data-target="#myModal14"><i class="icon-android-add-circle" title="CLICK HERE" style="color: black;font-size: 15px;"></i></a>
																			<a href="" data-toggle="modal" data-target="#Donation80GGCModal" id="Donation80GGC" onclick="changeName(this.id);"><i class="icon-upload22" title="Upload Donation Document" style="color: black;font-size: 15px;"></i></a>
																			</center>
																			<!-- Modal -->
																		...
																		<th style="width: 180px;" id="tablePadding"><center>
																				<div class="input-group">
																					<span class="input-group-addon">Rs.</span> <input
																						...
																						id="PayabletotalF" value="" readonly="readonly">
																				</div>
																			</center></th>
																		<th></th>
																	</tr>
					                    ...
					                    <div class="card-block border-bottom-blue-grey">
					                        <div class="row">
		                                            ...
		                                            <b><input class="form-control" name="TaxableIncome"
															id="TaxableIncome" value="<%=tf.getTotal_h() %>" readonly="readonly"></b>
		                                         </div>
                                        	 ...
                                        	 <div class="row">
		                                         ...
		                                         <div class="col-lg-3">
		                                            ...
		                                            <b><input class="form-control" name="TaxPayable" id="TaxPayable"
																value="<%=tf.getTax_payable() %>" readonly="readonly"></b>
		                                         </div>
                                        	 </div>
					                    </div>
					                </div>
                                ...
                                <div class="panel panel-default">
									...
									<div class="panel-body">
											<table class="table-responsive table-bordered" width="100%">
												<%	double sum = 0.0;
													List<TDSTaxBean> listOfTaxById = tdsListDAO.getTDSTaxListById(id, emp_id);
...
<div class="modal fade text-xs-left" id="IncomeModal" tabindex="-1"
					...
					<div class="row" id="in">
						<div class="col-md-6">
							<form action="tdsDocumentInsert" class="dropzone" method="post"
								...
								<input type="hidden" name="attachment_name" value="Income">
									...
									<div class="col-md-12">
										...
										<div class="col-md-8">
											<input type="text" class="form-control" name="amount"
												id="amount" value="0" onchange="showAttachment(value,'Income')">
										</div>
									</div>
								</div>
								
								<div id="IncomeAttachment">
								<div class="row">
									<div class="col-md-12">
						...
						<div class="col-md-6">
							<table class="table table-striped table-bordered table-hover" id="IncomeTable">
								...
								<tbody>
								<% List<TDSDocumentUploadBean> tdsDocumentUploadForIncome = tdsListDAO.getDocumentList(id, "Income"); 
								...
								<tr>
									...
									<td><i class="icon-trash-a" id="<%=uploadBean.getTds_document_upload_id() %>" style="color: red;" onclick="deleteDocument(id,'Income');"></i></td>
								</tr>
								<%} %>
								</tbody>
							</table>
	...
	<!-- LIC Modal -->
	<div class="modal fade text-xs-left" id="LICModal" tabindex="-1"
		role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-6">
							<form action="tdsDocumentInsert" class="dropzone" method="post"
								name="" enctype="multipart/form-data">
								<input type="hidden" name="attachment_name" value="LIC">
								<input type="hidden" name="tds_id" value="<%=id%>" />
								<div class="row">
									<div class="col-md-12">
										<div class="col-md-4">
									...
									<div class="col-md-12">
										...
										<div class="col-md-8">
											<input type="text" class="form-control" name="amount"
												id="amount" value="0" onchange="showAttachment(value,'LIC')">
										</div>
									</div>
								</div>
								<div id="LICAttachment">
								<div class="row">
									<div class="col-md-12">
										<div class="col-md-4">Attachment :</div>
									</div>
								...
								<div class="row">
									<div class="col-md-12" style="border: 1px solid #D4D4D4;">
										...
										<div class="fallback">
											<input name="attachment" type="file" onchange="payable();"/>
										</div>
									</div>
								</div>
								</div>
						...
						<div class="col-md-6">
							<table class="table table-striped table-bordered table-hover" id="LICTable">
								<thead>
								<tr>
									<th>Month</th>
									<th>Proof</th>
								...
								<tbody>
								<% List<TDSDocumentUploadBean> tdsDocumentUploadForLIC = tdsListDAO.getDocumentList(id, "LIC"); 
									for(TDSDocumentUploadBean uploadBean : tdsDocumentUploadForLIC){
								%>
								...
								<tr>
									...
									<td><%=uploadBean.getAmount() %></td>
									<td><i class="icon-trash-a" id="<%=uploadBean.getTds_document_upload_id() %>" style="color: red;" onclick="deleteDocument(id,'LIC');"></i></td>
								</tr>
								<%} %>
								</tbody>
							</table>
...
<!-- 	EPF  -->
		<div class="modal fade text-xs-left" id="EPFModal" tabindex="-1"
			role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-6">
							<form action="tdsDocumentInsert" class="dropzone" method="post"
								name="" enctype="multipart/form-data">
								<input type="hidden" name="attachment_name" value="EPF">
								<input type="hidden" name="tds_id" value="<%=id%>" />
								<div class="row">
									<div class="col-md-12">
										<div class="col-md-4">
									...
									<div class="col-md-12">
										...
										<div class="col-md-8">
											<input type="text" class="form-control" name="amount"
												id="amount" value="0" onchange="showAttachment(value,'EPF')">
										</div>
									</div>
								</div>
								<div id="EPFAttachment">
								<div class="row">
									<div class="col-md-12">
										<div class="col-md-4">Attachment :</div>
									</div>
						...
						<div class="col-md-6">
							<table class="table table-striped table-bordered table-hover" id="EPFTable">
								<thead>
								<tr>
									<th>Month</th>
									<th>Proof</th>
								...
								<tbody>
								<% List<TDSDocumentUploadBean> tdsDocumentUploadForEPF = tdsListDAO.getDocumentList(id, "EPF"); 
								...
								<tr>
									...
									<td><%=uploadBean.getAmount() %></td>
									<td><i class="icon-trash-a" id="<%=uploadBean.getTds_document_upload_id() %>" style="color: red;" onclick="deleteDocument(id,'EPF');"></i></td>
								</tr>
								<%} %>
								</tbody>
							</table>
	...
	<!-- PPF -->
		<div class="modal fade text-xs-left" id="PPFModal" tabindex="-1"
			role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-6">
							<form action="tdsDocumentInsert" class="dropzone" method="post"
								name="" enctype="multipart/form-data">
								<input type="hidden" name="attachment_name" value="PPF">
								<input type="hidden" name="tds_id" value="<%=id%>" />
								<div class="row">
									<div class="col-md-12">
										<div class="col-md-4">
									...
									<div class="col-md-12">
										...
										<div class="col-md-8">
											<input type="text" class="form-control" name="amount"
												id="amount" value="0" onchange="showAttachment(value,'PPF')">
										</div>
									</div>
								</div>
								<div id="PPFAttachment">
								<div class="row">
									<div class="col-md-12">
										<div class="col-md-4">Attachment :</div>
									</div>
						...
						<div class="col-md-6">
							<table class="table table-striped table-bordered table-hover" id="PPFTable">
								<thead>
								<tr>
									<th>Month</th>
									<th>Proof</th>
								...
								<tbody>
								<% List<TDSDocumentUploadBean> tdsDocumentUploadForPPF = tdsListDAO.getDocumentList(id, "PPF"); 
								...
								<tr>
									...
									<td><%=uploadBean.getAmount() %></td>
									<td><i class="icon-trash-a" id="<%=uploadBean.getTds_document_upload_id() %>" style="color: red;" onclick="deleteDocument(id,'PPF');"></i></td>
								</tr>
								<%} %>
								</tbody>
							</table>
	...
	<!-- NSC -->
		<div class="modal fade text-xs-left" id="NSCModal" tabindex="-1"
			role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-6" >
							<form action="tdsDocumentInsert" class="dropzone" method="post"
								name="" enctype="multipart/form-data">
								<input type="hidden" name="attachment_name" value="NSC">
								<input type="hidden" name="tds_id" value="<%=id%>" />
								<div class="row">
									<div class="col-md-12">
										<div class="col-md-4">
									...
									<div class="col-md-12">
										...
										<div class="col-md-8">
											<input type="text" class="form-control" name="amount"
												id="amount" value="0" onchange="showAttachment(value,'NSC')">
										</div>
									</div>
								</div>
								<div id="NSCAttachment">
								<div class="row">
									<div class="col-md-12">
										<div class="col-md-4">Attachment :</div>
									</div><br>
						...
						<div class="col-md-6">
							<table class="table table-striped table-bordered table-hover" id="NSCTable">
								<thead>
								<tr>
									<th>Month</th>
									<th>Proof</th>
								...
								<tbody>
								<% List<TDSDocumentUploadBean> tdsDocumentUploadForNSC = tdsListDAO.getDocumentList(id, "NSC"); 
								...
								<tr>
									...
									<td><%=uploadBean.getAmount() %></td>
									<td><i class="icon-trash-a" id="<%=uploadBean.getTds_document_upload_id() %>" style="color: red;" onclick="deleteDocument(id,'NSC');"></i></td>
								</tr>
								<%} %>
								</tbody>
							</table>
	...
	<!-- MF  -->
		<div class="modal fade text-xs-left" id="MFModal" tabindex="-1"
			role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-6">
							<form action="tdsDocumentInsert" class="dropzone" method="post"
								name="" enctype="multipart/form-data">
								<input type="hidden" name="attachment_name" value="MF">
								<input type="hidden" name="tds_id" value="<%=id%>" />
								<div class="row">
									<div class="col-md-12">
										<div class="col-md-4">
									...
									<div class="col-md-12">
										...
										<div class="col-md-8">
											<input type="text" class="form-control" name="amount"
												id="amount" value="0" onchange="showAttachment(value,'MF')">
										</div>
									</div>
								</div>
								<div id="MFAttachment">
						...
						<div class="col-md-6">
							<table class="table table-striped table-bordered table-hover" id="MFTable">
								<thead>
								<tr>
									<th>Month</th>
									<th>Proof</th>
								...
								<tbody>
								<% List<TDSDocumentUploadBean> tdsDocumentUploadForMF = tdsListDAO.getDocumentList(id, "MF"); 
								...
								<tr>
									...
									<td><%=uploadBean.getAmount() %></td>
									<td><i class="icon-trash-a" id="<%=uploadBean.getTds_document_upload_id() %>" style="color: red;" onclick="deleteDocument(id,'MF');"></i></td>
								</tr>
								<%} %>
								</tbody>
							</table>
	...
	<!-- TuitionFees -->
		<div class="modal fade text-xs-left" id="TuitionFeesModal" tabindex="-1"
			role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-6">
							<form action="tdsDocumentInsert" class="dropzone" method="post"
								name="" enctype="multipart/form-data">
								<input type="hidden" name="attachment_name" value="TuitionFees">
								<input type="hidden" name="tds_id" value="<%=id%>" />
								<div class="row">
									<div class="col-md-12">
										<div class="col-md-4">
									...
									<div class="col-md-12">
										...
										<div class="col-md-8">
											<input type="text" class="form-control" name="amount"
												id="amount" value="0" onchange="showAttachment(value,'TuitionFees')">
										</div>
									</div>
								</div>
								<div id="TuitionFeesAttachment">
								<div class="row">
									<div class="col-md-12">
										<div class="col-md-4">Attachment :</div>
									</div>
						...
						<div class="col-md-6">
							<table class="table table-striped table-bordered table-hover" id="TuitionFeesTable">
								<thead>
								<tr>
									<th>Month</th>
									<th>Proof</th>
								...
								<tbody>
								<% List<TDSDocumentUploadBean> tdsDocumentUploadForTuitionFees = tdsListDAO.getDocumentList(id, "TuitionFees"); 
								...
								<tr>
									...
									<td><%=uploadBean.getAmount() %></td>
									<td><i class="icon-trash-a" id="<%=uploadBean.getTds_document_upload_id() %>" style="color: red;" onclick="deleteDocument(id,'TuitionFees');"></i></td>
								</tr>
								<%} %>
								</tbody>
							</table>
	...
	<!-- StampDuty -->
		<div class="modal fade text-xs-left" id="StampDutyModal" tabindex="-1"
			role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-6">
							<form action="tdsDocumentInsert" class="dropzone" method="post"
								name="" enctype="multipart/form-data">
								<input type="hidden" name="attachment_name" value="StampDuty">
								<input type="hidden" name="tds_id" value="<%=id%>" />
								<div class="row">
									<div class="col-md-12">
										<div class="col-md-4">
									...
									<div class="col-md-12">
										...
										<div class="col-md-8">
											<input type="text" class="form-control" name="amount"
												id="amount" value="0" onchange="showAttachment(value,'StampDuty')">
										</div>
									</div>
								</div>
								<div id="StampDutyAttachment">
								<div class="row">
									<div class="col-md-12">
										<div class="col-md-4">Attachment :</div>
									</div>
						...
						<div class="col-md-6">
							<table class="table table-striped table-bordered table-hover" id="StampDutyTable">
								<thead>
								<tr>
									<th>Month</th>
									<th>Proof</th>
								...
								<tbody>
								<% List<TDSDocumentUploadBean> tdsDocumentUploadForStampDuty = tdsListDAO.getDocumentList(id, "StampDuty"); 
								...
								<tr>
									...
									<td><%=uploadBean.getAmount() %></td>
									<td><i class="icon-trash-a" id="<%=uploadBean.getTds_document_upload_id() %>" style="color: red;" onclick="deleteDocument(id,'StampDuty');"></i></td>
								</tr>
								<%} %>
								</tbody>
							</table>
	...
	<!-- HouseLoan -->
		<div class="modal fade text-xs-left" id="HouseLoanModal" tabindex="-1"
			role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-6">
							<form action="tdsDocumentInsert" class="dropzone" method="post"
								name="" enctype="multipart/form-data">
								<input type="hidden" name="attachment_name" value="HouseLoan">
								<input type="hidden" name="tds_id" value="<%=id%>" />
								<div class="row">
									<div class="col-md-12">
										<div class="col-md-4">
									...
									<div class="col-md-12">
										...
										<div class="col-md-8">
											<input type="text" class="form-control" name="amount"
												id="amount" value="0" onchange="showAttachment(value,'HouseLoan')">
										</div>
									</div>
								</div>
								<div id="HouseLoanAttachment">
								<div class="row">
									<div class="col-md-12">
										<div class="col-md-4">Attachment :</div>
									</div>
						...
						<div class="col-md-6">
							<table class="table table-striped table-bordered table-hover" id="HouseLoanTable">
								<thead>
								<tr>
									<th>Month</th>
									<th>Proof</th>
								...
								<tbody>
								<% List<TDSDocumentUploadBean> tdsDocumentUploadForHouseLoan = tdsListDAO.getDocumentList(id, "HouseLoan"); 
								...
								<tr>
									...
									<td><%=uploadBean.getAmount() %></td>
									<td><i class="icon-trash-a" id="<%=uploadBean.getTds_document_upload_id() %>" style="color: red;" onclick="deleteDocument(id,'HouseLoan');"></i></td>
								</tr>
								<%} %>
								</tbody>
							</table>
	...
	<!-- FixDeposite -->
		<div class="modal fade text-xs-left" id="FixDepositeModal" tabindex="-1"
			role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-6">
							<form action="tdsDocumentInsert" class="dropzone" method="post"
								name="" enctype="multipart/form-data">
								<input type="hidden" name="attachment_name" value="FixDeposite">
								<input type="hidden" name="tds_id" value="<%=id%>" />
								<div class="row">
									<div class="col-md-12">
										<div class="col-md-4">
									...
									<div class="col-md-12">
										...
										<div class="col-md-8">
											<input type="text" class="form-control" name="amount"
												id="amount" value="0" onchange="showAttachment(value,'FixDeposite')">
										</div>
									</div>
								</div>
								<div id="FixDepositeAttachment">
								<div class="row">
									<div class="col-md-12">
										<div class="col-md-4">Attachment :</div>
									</div>
						...
						<div class="col-md-6">
							<table class="table table-striped table-bordered table-hover" id="FixDepositeTable">
								<thead>
								<tr>
									<th>Month</th>
									<th>Proof</th>
								...
								<tbody>
								<% List<TDSDocumentUploadBean> tdsDocumentUploadForFixDeposite = tdsListDAO.getDocumentList(id, "FixDeposite"); 
								...
								<tr>
									...
									<td><%=uploadBean.getAmount() %></td>
									<td><i class="icon-trash-a" id="<%=uploadBean.getTds_document_upload_id() %>" style="color: red;" onclick="deleteDocument(id,'FixDeposite');"></i></td>
								</tr>
								<%} %>
								</tbody>
							</table>
	...
	<!-- Other -->
		<div class="modal fade text-xs-left" id="OtherModal" tabindex="-1"
			role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-6">
							<form action="tdsDocumentInsert" class="dropzone" method="post"
								name="" enctype="multipart/form-data">
								<input type="hidden" name="attachment_name" value="Other">
								<input type="hidden" name="tds_id" value="<%=id%>" />
								<div class="row">
									<div class="col-md-12">
										<div class="col-md-4">
									...
									<div class="col-md-12">
										...
										<div class="col-md-8">
											<input type="text" class="form-control" name="amount"
												id="amount" value="0" onchange="showAttachment(value,'Other')">
										</div>
									</div>
								</div>
								<div id="OtherAttachment">
								<div class="row">
									<div class="col-md-12">
										<div class="col-md-4">Attachment :</div>
									</div>
						...
						<div class="col-md-6">
							<table class="table table-striped table-bordered table-hover" id="OtherTable">
								<thead>
								<tr>
									<th>Month</th>
									<th>Proof</th>
								...
								<tbody>
								<% List<TDSDocumentUploadBean> tdsDocumentUploadForOther = tdsListDAO.getDocumentList(id, "Other"); 
								...
								<tr>
									...
									<td><%=uploadBean.getAmount() %></td>
									<td><i class="icon-trash-a" id="<%=uploadBean.getTds_document_upload_id() %>" style="color: red;" onclick="deleteDocument(id,'Other');"></i></td>
								</tr>
								<%} %>
								</tbody>
							</table>
	...
	<!-- NPS Modal  -->
		<div class="modal fade text-xs-left" id="NPSModal" tabindex="-1"
			role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-6">
							<form action="tdsDocumentInsert" class="dropzone" method="post"
								name="" enctype="multipart/form-data">
								<input type="hidden" name="attachment_name" value="NPS">
								<input type="hidden" name="tds_id" value="<%=id%>" />
								<div class="row">
									<div class="col-md-12">
										<div class="col-md-4">
									...
									<div class="col-md-12">
										...
										<div class="col-md-8">
											<input type="text" class="form-control" name="amount"
												id="amountLIC" value="0" onchange="showAttachment(value,'NPS')">
										</div>
									</div>
								</div>
								<div id="NPSAttachment">
								<div class="row">
									<div class="col-md-12">
										<div class="col-md-4">Attachment :</div>
									</div>
						...
						<div class="col-md-6">
							<table class="table table-striped table-bordered table-hover" id="NPSTable">
								...
								<tbody>
								<% List<TDSDocumentUploadBean> tdsDocumentUploadForNPS = tdsListDAO.getDocumentList(id, "NPS"); 
								...
								<tr>
									...
									<td><%=uploadBean.getAmount() %></td>
									<td><i class="icon-trash-a" id="<%=uploadBean.getTds_document_upload_id() %>" style="color: red;" onclick="deleteDocument(id,'NPS');"></i></td>
								</tr>
								<%} %>
								</tbody>
							</table>
	...
	<!-- RGESS Modal -->
		<div class="modal fade text-xs-left" id="RGESSModal" tabindex="-1"
			role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-6">
							<form action="tdsDocumentInsert" class="dropzone" method="post"
								name="" enctype="multipart/form-data">
								<input type="hidden" name="attachment_name" value="RGESS">
								<input type="hidden" name="tds_id" value="<%=id%>" />
								<div class="row">
									<div class="col-md-12">
										<div class="col-md-4">
									...
									<div class="col-md-12">
										...
										<div class="col-md-8">
											<input type="text" class="form-control" name="amount"
												id="amountLIC" value="0" onchange="showAttachment(value,'RGESS')">
										</div>
									</div>
								</div>
								<div id="RGESSAttachment">
								<div class="row">
									<div class="col-md-12">
										<div class="col-md-4">Attachment :</div>
									</div>
						...
						<div class="col-md-6">
							<table class="table table-striped table-bordered table-hover" id="RGESSTable">
								...
								<tbody>
								<% List<TDSDocumentUploadBean> tdsDocumentUploadForRGESS = tdsListDAO.getDocumentList(id, "RGESS"); 
								...
								<tr>
									...
									<td><%=uploadBean.getAmount() %></td>
									<td><i class="icon-trash-a" id="<%=uploadBean.getTds_document_upload_id() %>" style="color: red;" onclick="deleteDocument(id,'RGESS');"></i></td>
								</tr>
								<%} %>
								</tbody>
							</table>
	...
	<!-- Mediclaim Modal -->
		<div class="modal fade text-xs-left" id="MediclaimModal" tabindex="-1"
			role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-6">
							<form action="tdsDocumentInsert" class="dropzone" method="post"
								name="" enctype="multipart/form-data">
								<input type="hidden" name="attachment_name" value="Mediclaim">
								<input type="hidden" name="tds_id" value="<%=id%>" />
								<div class="row">
									<div class="col-md-12">
										<div class="col-md-4">
									...
									<div class="col-md-12">
										...
										<div class="col-md-8">
											<input type="text" class="form-control" name="amount"
												id="amountLIC" value="0" onchange="showAttachment(value,'Mediclaim')">
										</div>
									</div>
								</div>
								<div id="MediclaimAttachment">
								<div class="row">
									<div class="col-md-12">
										<div class="col-md-4">Attachment :</div>
									</div>
						...
						<div class="col-md-6">
							<table class="table table-striped table-bordered table-hover" id="MediclaimTable">
								...
								<tbody>
								<% List<TDSDocumentUploadBean> tdsDocumentUploadForMediclaim = tdsListDAO.getDocumentList(id, "Mediclaim"); 
								...
								<tr>
									...
									<td><%=uploadBean.getAmount() %></td>
									<td><i class="icon-trash-a" id="<%=uploadBean.getTds_document_upload_id() %>" style="color: red;" onclick="deleteDocument(id,'Mediclaim');"></i></td>
								</tr>
								<%} %>
								</tbody>
							</table>
	...
	<!-- Donation 80G -->
		<div class="modal fade text-xs-left" id="Donation80GModal" tabindex="-1"
			role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-6">
							<form action="tdsDocumentInsert" class="dropzone" method="post"
								name="" enctype="multipart/form-data">
								<input type="hidden" name="attachment_name" value="Donation80G">
								<input type="hidden" name="tds_id" value="<%=id%>" />
								<div class="row">
									<div class="col-md-12">
										<div class="col-md-4">
									...
									<div class="col-md-12">
										...
										<div class="col-md-8">
											<input type="text" class="form-control" name="amount"
												id="amountLIC" value="0" onchange="showAttachment(value,'Donation80G')">
										</div>
									</div>
								</div>
								<div id="Donation80GAttachment">
								<div class="row">
									<div class="col-md-12">
										<div class="col-md-4">Attachment :</div>
									</div>
						...
						<div class="col-md-6">
							<table class="table table-striped table-bordered table-hover" id="Donation80GTable">
								...
								<tbody>
								<% List<TDSDocumentUploadBean> tdsDocumentUploadForDonation80G = tdsListDAO.getDocumentList(id, "Donation80G"); 
								...
								<tr>
									...
									<td><%=uploadBean.getAmount() %></td>
									<td><i class="icon-trash-a" id="<%=uploadBean.getTds_document_upload_id() %>" style="color: red;" onclick="deleteDocument(id,'Donation80G');"></i></td>
								</tr>
								<%} %>
								</tbody>
							</table>
	...
	<!-- Donation 80GGC -->
		<div class="modal fade text-xs-left" id="Donation80GGCModal" tabindex="-1"
			role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-hidden="true">&times;</button>
					<h4 class="modal-title" id="myModalLabel">Donation 80GGC</h4>
				</div>
				<div class="modal-body">
					<div class="row">
						<div class="col-md-6">
							<form action="tdsDocumentInsert" class="dropzone" method="post"
								name="" enctype="multipart/form-data">
								<input type="hidden" name="attachment_name" value="Donation80GGC">
								<input type="hidden" name="tds_id" value="<%=id%>" />
								<div class="row">
									<div class="col-md-12">
										<div class="col-md-4">
									...
									<div class="col-md-12">
										...
										<div class="col-md-8">
											<input type="text" class="form-control" name="amount"
												id="amountLIC" value="0" onchange="showAttachment(value,'Donation80GGC')">
										</div>
									</div>
								</div>
								<div id="Donation80GGCAttachment">
								<div class="row">
									<div class="col-md-12">
										<div class="col-md-4">Attachment :</div>
									</div>
						...
						<div class="col-md-6">
							<table class="table table-striped table-bordered table-hover" id="Donation80GGCTable">
								...
								<tbody>
								<% List<TDSDocumentUploadBean> tdsDocumentUploadForDonation80GGC = tdsListDAO.getDocumentList(id, "Donation80GGC"); 
								...
								<tr>
									...
									<td><%=uploadBean.getAmount() %></td>
									<td><i class="icon-trash-a" id="<%=uploadBean.getTds_document_upload_id() %>" style="color: red;" onclick="deleteDocument(id,'Donation80GGC');"></i></td>
								</tr>
								<%} %>
								</tbody>
							</table>
	...
	<script>
		...
		function deleteDocument(id1,aName) {
			//alert("yash");
			//alert(id1);
			//alert("table name :"+aName);
			
			$.ajax({
				 method: "POST",
				 url: 'tdsDocumentDelete',
				data : {
					tds_doc_id :id1
				},
					...
					alert('Document Deleted Successfully....');
			    		...
			    		var id = aName+"Table";
			    		 // alert(id);
			    		  ...
			    		  //alert("total C"+totalc);
			    		  
			    		  var totalE = $("#TotalE").val();
			    		  //alert("total E"+totalE);
			    		  
			    		  var total_donation = $("#TotalF").val();
			    		  //alert("F :"+total_donation);
			    	  $.ajax({
			  	        type: "GET",
			  	        ...
			  	        success: function(data){
			  	        	...
			  	        	var json = JSON.parse(data);
			  	   		    ...
			  	   		    var html = " <tr><td>"+f["monthBean"].month_name+"</td>" +
			  	   				...
			  	   				"<img src=\"FileServlet?path=D:\\hrms\\upload\\TDSDocument\\"+f.attachment+"\""+
											...
											"tabindex=\"0\" data-placement=\"left\" data-toggle=\"popover\" data-trigger=\"hover\" data-content=\"<div class='media'><a href='#' class='pull-left'><img src='FileServlet?path=D:\\hrms\\upload\\TDSDocument\\"+f.attachment+"' height='250px' width='250px' alt='Sample Image'></a></div>\"" +
			  	   								"</a></td>"+
			  	   								"<td>"+f.amount+"</td>"+
					    	...
					    	$(html).appendTo("#"+id+" tbody");
					    	$("#"+aName+"Payable").val(sum);
					    	
					    	//alert("Sum :"+sum);
					    	lic = parseFloat($("#LICPayable").val());
					    	epf = parseFloat($("#EPFPayable").val());
					    	ppf = parseFloat($("#PPFPayable").val());
					    	nsc = parseFloat($("#NSCPayable").val());
					    	mf = parseFloat($("#MFPayable").val());
					    	tuition_fees = parseFloat($("#TuitionFeesPayable").val());
					    	stamp_duty = parseFloat($("#StampDutyPayable").val());
					    	house_loan = parseFloat($("#HouseLoanPayable").val());
					    	fix_deposite = parseFloat($("#FixDepositePayable").val());
					    	other = parseFloat($("#OtherPayable").val());
					    	
					    	total = lic + epf + ppf + nsc + mf + tuition_fees + stamp_duty + house_loan + fix_deposite + other;
					    	$("#PayableTotalD").val(total);
					    	
					    	if(total <= 150000){
					    		$("#Payable80CTotal").val(total);
					    		 totald = totalc - total;
					    		$("#PayabletotalD").val(totald);
					    		/* totale = totald - totalE ;
					    		$("#PayabletotalE").val(totale);
					    		totalf = totale - total_donation ;
					    		$("#PayabletotalF").val(totalf); */
					    	}else{
					    		$("#Payable80CTotal").val(150000);
					    		 totald = totalc - total;
					    		$("#PayabletotalD").val(totald);
					    		/* totale = totald - totalE ;
					    		$("#PayabletotalE").val(totale);
