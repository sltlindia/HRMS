...
<%
 //int employee_code = user.getEmployee_master_id();
...
System.out.println("EMPLOYEE MASTER ID " + employee_code);
int month_id =0;
int q_id =0;
int id = 0;
List<AppraisalBean> appraisalBean = allListDAO.getappraisal(appraisal_id);
for(AppraisalBean a : appraisalBean){
	month_id = a.getMonthBean().getMonth_id();
	q_id = a.getQuterlyMonthBean().getQuarterly_month_id();
}
...
System.out.println("TOTAL DAY " + TOTALLEAVEDAY);
			...
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">
						Attendance / Kizen / 5S Score / Training Details</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			<br>
<!-- <div id="wrapper">
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">Attendance / Kizen / 5S Score / Training Details</h1>
				</div>
				/.col-lg-12
			</div> -->
			<!-- /.row -->
			<div class="row">
				    <div class="col-md-12">
                        ...
                        <h5 style="color:red">&nbsp;&nbsp; Note : Its compulsory to provide the rating under this section.Kindly provide rating
                        based on observation and experience with your reportee.
                        </h5>
				...
				<form action="appraisalSection1Insert" method="post" enctype="multipart/form-data">
							<div class="panel-group" id="accordion">
								<div class="panel panel-default">
									...
									<th><center>Ratings <a href="" data-toggle="modal" data-target="#myModal"><i class="icon-android-alert"  data-toggle="tooltip" data-placement="top" title="Description"></i></a></center></th>
									</tr>
									</thead>
									...
									<td><input type="text" name="leave" id="name" value="<%= TOTALLEAVEDAY %>" class="form-control" onchange="checkInteger(this.id)"></td>
...
<br>
							...
							<div class="panel-group" id="accordion">
								...
								<div class="card-block" style= "outline-style:solid; outline-color: #607D8B; outline-width: 2px">
									...
									<td><input type="date" name="tDate" id="date<%=i+1%>" value="" class="form-control" placeholder="yyyy-mm-dd"></td>
								...
								<br>
								<h4>Legends :</h4> <i class="icon-android-alert" style="color: #337ab7" title="Description"></i> Description Of Ratings
							</div>
