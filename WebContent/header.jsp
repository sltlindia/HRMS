				...
				%>
                   ...
                   <a href="LeaveODManagerShow?OD_ID=<%=leaveODBean.getOD_ID()%>"
							...
							<%} %>
								...
								<%
>>>>>>> 8ac1ef193db2799ffcac29c377223a0e49b2b57c
                  String color = null;
...
>>>>>>> 8ac1ef193db2799ffcac29c377223a0e49b2b57c
								...
								<li class="menu-list">
									<ul class="mega-menu-sub">
										<li><a href="selfService.jsp" class="dropdown-item"><i></i>Upload
												Document</a></li>
										<li><a href="selfServiceList.jsp" class="dropdown-item"><i></i>My
												Document</a></li>
	...
	<script src="app-assets/vendors/js/charts/morris.min.js"
		type="text/javascript"></script>
	<script src="app-assets/vendors/js/charts/chart.min.js"
		type="text/javascript"></script>
	<script
		src="app-assets/vendors/js/charts/jvector/jquery-jvectormap-2.0.3.min.js"
		type="text/javascript"></script>
	<script
		src="app-assets/vendors/js/charts/jvector/jquery-jvectormap-world-mill.js"
		type="text/javascript"></script>
	...
	<script src="app-assets/vendors/js/extensions/clndr.min.js"
		type="text/javascript"></script>
	<script src="app-assets/vendors/js/charts/echarts/echarts.js"
		type="text/javascript"></script>
	...
	<!-- END ROBUST JS-->
	<!-- BEGIN PAGE LEVEL JS-->
	<script src="app-assets/js/scripts/pages/dashboard-ecommerce.min.js"
		type="text/javascript"></script>
	<!-- END PAGE LEVEL JS-->
	<script>
