														...
														<table
															...
															<tbody>
																<%
																	...
																	List<VehicleDocumentBean> listOfVehicleDocuments = allListVtsDAO3.getListOfVehicleDocumentsById(Integer.parseInt(request.getParameter("vehicle_master_id")));
																	for (VehicleDocumentBean t : listOfVehicleDocuments) {
																		int vehicle_document_id = t.getVehicle_document_id();
																		List<VehicleDocumentAttachmentBean> listOfVehicleDocumentAttachments = allListVtsDAO3.getListOfVehicleDocumentAttachments(vehicle_document_id);
																%>
																<tr>
																	<td><%=k++ %></td>
																	<td><%=t.getVehicleBean().getVehicle_name()%></td>
																	<td><%=t.getVehicleBean().getVehicle_no()%></td>
																	<td><%=t.getDocument_name() %></td>
																	<td>
																		<%
																		for (VehicleDocumentAttachmentBean t1 : listOfVehicleDocumentAttachments) {
																		String ext2 = FilenameUtils.getExtension(t1.getVehicle_attachment_name());
