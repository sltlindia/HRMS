													...
													<div class="panel-group" id="accordion">
																			...
																			<tbody>
																				<tr>
																					<input type="hidden" name="project_master_id"
																						value="<%=request.getParameter("project_master_id")%>">
																					<input type="hidden" name="project_master_name"
																						value="<%=request.getParameter("project_master_name")%>">
														...
														<div class="panel panel-default">
																...
																<div class="panel-body">
																	<div class="table-responsive">
																		...
																		<table
																			...
																			<tbody>
																				<tr>
																					<td><input type="hidden" name="task_master_id"
																						value="<%=projectAllocationBean.getTaskMasterBean().getTask_master_id()%>"><%=projectAllocationBean.getTaskMasterBean().getTask_master_name()%></td>
																					...
																					<td width="97px"><input type="text"
																						...
																						id="workedHours" value="0"
																						onchange="checkInteger(this.id)"></td>
																					<td width="97px"><input type="text"
																						name="percentage_completed" size="3"
																						id="<%=projectAllocationBean.getTaskMasterBean().getTask_master_id()%>"
															...
															<input type="submit" class="btn btn-success" value="Save"
																onclick="save(1)" /> <input type="button"
													...
													<div class="row">
														<div class="panel-body">
															...
															<a
																...
																class="btn btn-primary btn-lg" onclick="save(3)">
															</a>
															<!-- /.modal -->
														</div>
														<!-- .panel-body -->
