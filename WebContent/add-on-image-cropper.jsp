...
<!-- Mirrored from pixinvent.com/bootstrap-admin-template/robust/html/ltr/horizontal-menu-template/add-on-image-cropper.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Aug 2017 08:53:00 GMT -->
<head>
    ...
    <title>Image Cropper - Robust Bootstrap Admin Template</title>
    ...
    <link rel="stylesheet" type="text/css" href="../../../app-assets/css/plugins/images/cropper/cropper.min.css">
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
    <link rel="stylesheet" type="text/css" href="../../../assets/css/style.css">
    <!-- END Custom CSS-->
                ...
                <ul class="drilldown-menu">
                  <li class="menu-list">
                    <ul class="mega-menu-sub">
                      ...
                      <li class="active"><a href="add-on-image-cropper.html" class="dropdown-item"><i class="icon-crop"></i>Image Cropper</a>
                      </li>
      ...
      <div class="content-wrapper">
        <div class="content-header row">
          <div class="content-header-left col-md-6 col-xs-12">
            <h2 class="content-header-title mb-0">Image Cropper</h2>
                        ...
                        <div class="row mb-1">
                            <div class="col-md-2 col-sm-12">
                                <fieldset class="form-group text-xs-center">
                                    <button class="btn btn-outline-deep-orange rotate-m45-deg" type="button">Rotate -45&deg;</button>
                                </fieldset>
                            </div>

                            <div class="col-md-2 col-sm-12">
                                <fieldset class="form-group text-xs-center">
                                    <button class="btn btn-outline-teal rotate-45-deg" type="button">Rotate 45&deg;</button>
                                </fieldset>
                            </div>

                            <div class="col-md-2 col-sm-12">
                                <fieldset class="form-group text-xs-center">
                                    <button class="btn btn-outline-pink rotate-180-deg" type="button">Rotate 180&deg;</button>
                                </fieldset>
                            </div>

                            <div class="col-md-2 col-sm-12">
                                <fieldset class="form-group text-xs-center">
                                    <button class="btn btn-outline-deep-orange flip-horizontal" type="button" data-option="1">Flip Horizontal</button>
                                </fieldset>
                            </div>

                            <div class="col-md-2 col-sm-12">
                                <fieldset class="form-group text-xs-center">
                                    <button class="btn btn-outline-teal flip-vertical" type="button" data-option="1">Flip Vertical</button>
                                </fieldset>
                            </div>

                            <div class="col-md-2 col-sm-12">
                                <fieldset class="form-group text-xs-center">
                                    <button class="btn btn-outline-pink zoom-in" type="button">Zoom In</button>
                                </fieldset>
                            </div>
                        </div>
                                ...
                                <fieldset class="form-group">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn">
                                            <button class="btn btn-outline-deep-orange get-data-btn" type="button">Get Data</button>
                                        </span>
                                    </div>
                                </fieldset>
                            </div>
                            ...
                            <div class="col-md-4">
                                <fieldset class="form-group">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn">
                                            <button class="btn btn-outline-teal get-image-data-btn" type="button">Get Image Data</button>
                                        </span>
                                    </div>
                                </fieldset>
                            </div>
                            ...
                            <div class="col-md-4">
                                <fieldset class="form-group">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn">
                                            <button class="btn btn-outline-pink get-container-data-btn" type="button">Get Container Data</button>
                                        </span>
                                    </div>
                                </fieldset>
                            </div>
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn">
                                            <button class="btn btn-outline-deep-orange get-canvas-data-btn" type="button">Get Canvas Data</button>
                                        </span>
                                    </div>
                                </fieldset>
                            </div>
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn">
                                            <button class="btn btn-outline-pink get-cropbox-data-btn" type="button">Get Crop Box Data</button>
                                        </span>
                                    </div>
                                </fieldset>
                            </div>
    ...
    <div class="row">
        ...
        <div class="col-xl-6 col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="card-block overflow-hidden">
                        <p class="font-small-3">This example demonstrate the cropper ratio fixed to <code>16:9</code>. This must be set using the <code>aspectRatio</code> option.</p>
        ...
        <div class="col-xl-6 col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="card-block overflow-hidden">
                        <p class="font-small-3">This example demonstrate the cropper ratio fixed to <code>4:3</code>. This must be set using the <code>aspectRatio</code> option.</p>
    ...
    <div class="row">
        ...
        <div class="col-xl-6 col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="card-block overflow-hidden">
                        <p class="font-small-3">This example demonstrate the fixed cropper that you can not move but you can increase - decrease the size of the cropper by dragging.</p>
        ...
        <div class="col-xl-6 col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="card-block overflow-hidden">
                        <p class="font-small-3">This example demonstrate the fixed size of the cropper. You can move the crop box but can not increase or decrease the size of the cropper.</p>
    ...
    <div class="row">
        ...
        <div class="col-xl-6 col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="card-block overflow-hidden">
                        <p class="font-small-3">This example demonstrate how to disable the autocrop feature. You need to set <code>autoCrop</code> option to <code>false</code> in order to disable.</p>
        ...
        <div class="col-xl-6 col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="card-block overflow-hidden">
                        <p class="font-small-3">This example demonstrate how to restrict a user from creating a new cropbox and just allowing to work with pre-defined cropbox.</p>
    ...
    <div class="row">
        ...
        <div class="col-xl-6 col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="card-block overflow-hidden">
                        <p class="font-small-3">In this example we have set minimum crop area size to <code>100 X 100</code>. User can not make smaller cropbox than limit applied.</p>
        ...
        <div class="col-xl-6 col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="card-block overflow-hidden">
                        <p class="font-small-3">This example demonstrate how to disable the default background. Set <code>background</code> option to <code>false</code> in order to disable default background.</p>
    ...
    <div class="row">
        ...
        <div class="col-xl-6 col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="card-block overflow-hidden">
                        <p class="font-small-3">This example demonstrate how to rotate the default image. Required to use <code>built</code> function to rotate image after setting all the options. </p>
        ...
        <div class="col-xl-6 col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="card-block overflow-hidden">
                        <p class="font-small-3">This example demonstrate how to scale the default image. Required to use <code>built</code> function to scale image after setting all the options.</p>
...
<!-- // Image cropper section end -->
    ...
    <script src="../../../app-assets/vendors/js/extensions/cropper.min.js" type="text/javascript"></script>
    <!-- END PAGE VENDOR JS-->
    <!-- BEGIN ROBUST JS-->
    ...
    <!-- END ROBUST JS-->
    <!-- BEGIN PAGE LEVEL JS-->
    <script src="../../../app-assets/js/scripts/extensions/image-cropper.min.js" type="text/javascript"></script>
    <!-- END PAGE LEVEL JS-->
  	<script>
...
<!-- Mirrored from pixinvent.com/bootstrap-admin-template/robust/html/ltr/horizontal-menu-template/add-on-image-cropper.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Aug 2017 08:53:02 GMT -->
</html>
